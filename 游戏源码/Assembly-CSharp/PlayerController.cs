...
public class PlayerController : KMonoBehaviour, IInputHandler
{
	...
	{
		Instance = this;
		InterfaceTool.InitializeConfigs(defaultConfigKey, interfaceConfigs);
	...
	private void UpdateDrag()
	{
		...
		if (!dragging && CanDrag() && ((mousePos - startDragPos).sqrMagnitude > 36f || Time.unscaledTime - startDragTime > 0.3f))
		{
			dragging = true;
		}
