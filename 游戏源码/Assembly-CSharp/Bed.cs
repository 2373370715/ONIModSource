...
public class Bed : Workable, IGameObjectEffectDescriptor, IBasicBuilding
{
	...
	protected override void OnSpawn()
	{
		...
		obj.OnWorkableEventCB = (Action<Workable, WorkableEvent>)Delegate.Combine(obj.OnWorkableEventCB, new Action<Workable, WorkableEvent>(OnWorkableEvent));
	}
	...
	protected override void OnCleanUp()
	{
		...
		{
			Sleepable obj = sleepable;
			obj.OnWorkableEventCB = (Action<Workable, WorkableEvent>)Delegate.Remove(obj.OnWorkableEventCB, new Action<Workable, WorkableEvent>(OnWorkableEvent));
		}
	}
}
