...
public class FoodSickness : Sickness
{
	...
	public FoodSickness()
		: base("FoodSickness", SicknessType.Pathogen, Severity.Minor, 0.005f, new List<InfectionVector> { InfectionVector.Digestion }, 1020f, "FoodSicknessRecovery")
	{
		...
		{
			new AttributeModifier("BladderDelta", 1f / 3f, DUPLICANTS.DISEASES.FOODSICKNESS.NAME),
