...
public class PlantBlightEvent : GameplayEvent<PlantBlightEvent.StatesInstance>
{
	public class States : GameplayEventStateMachine<States, StatesInstance, GameplayEventManager, PlantBlightEvent>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			running.ToggleNotification((StatesInstance smi) => EventInfoScreen.CreateNotification(GenerateEventPopupData(smi))).EventHandlerTransition(GameHashes.Uprooted, finished, NoBlightedPlants).DefaultState(running.waiting)
