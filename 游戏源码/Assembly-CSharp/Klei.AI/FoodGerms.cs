...
public class FoodGerms : Disease
{
	...
	public FoodGerms(bool statsOnly)
		: base("FoodPoisoning", 10f, new RangeInfo(248.15f, 278.15f, 313.15f, 348.15f), new RangeInfo(10f, 1200f, 1200f, 10f), new RangeInfo(0f, 0f, 1000f, 1000f), RangeInfo.Idempotent(), 2.5f, statsOnly)
	{
	}
