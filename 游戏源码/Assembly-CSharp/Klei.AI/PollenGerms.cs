...
public class PollenGerms : Disease
{
	...
	public PollenGerms(bool statsOnly)
		: base("PollenGerms", 5f, new RangeInfo(263.15f, 273.15f, 363.15f, 373.15f), new RangeInfo(10f, 100f, 100f, 10f), new RangeInfo(0f, 0f, 1000f, 1000f), RangeInfo.Idempotent(), 0f, statsOnly)
	{
	}
