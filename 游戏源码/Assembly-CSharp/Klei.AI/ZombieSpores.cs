...
public class ZombieSpores : Disease
{
	...
	public ZombieSpores(bool statsOnly)
		: base("ZombieSpores", 50f, new RangeInfo(168.15f, 258.15f, 513.15f, 563.15f), new RangeInfo(10f, 1200f, 1200f, 10f), new RangeInfo(0f, 0f, 1000f, 1000f), RangeInfo.Idempotent(), 1f, statsOnly)
	{
	}
