...
public class NuclearResearchCenterWorkable : Workable
{
	...
	protected override void OnStartWork(Worker worker)
	{
		...
		GetComponent<KSelectable>().AddStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching, nrc);
	}
	...
	protected override void OnStopWork(Worker worker)
	{
		...
		GetComponent<KSelectable>().RemoveStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorResearching, nrc);
	}
