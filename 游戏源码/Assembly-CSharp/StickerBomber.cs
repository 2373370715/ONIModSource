...
public class StickerBomber : GameStateMachine<StickerBomber, StickerBomber.Instance>
{
	...
	public new class Instance : GameInstance
	{
		private class StickerBombReactable : Reactable
		{
			...
			private Func<int, bool> canPlaceStickerCb = delegate(int cell)
			{
				...
				return !Grid.IsCellOpenToSpace(cell);
			};
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		overjoyed.TagTransition(GameTags.Overjoyed, neutral, on_remove: true).DefaultState(overjoyed.idle).ToggleStatusItem(Db.Get().DuplicantStatusItems.JoyResponse_StickerBombing);
