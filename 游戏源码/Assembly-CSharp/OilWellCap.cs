...
public class OilWellCap : Workable, ISingleSliderControl, ISliderControl, IElementEmitter
{
	...
	public class States : GameStateMachine<States, StatesInstance, OilWellCap>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			operational.DefaultState(operational.idle).ToggleRecurringChore((StatesInstance smi) => smi.master.CreateWorkChore()).EventHandler(GameHashes.WorkChoreDisabled, delegate(StatesInstance smi)
			{
	...
	{
		DepressurizeChore = new WorkChore<OilWellCap>(Db.Get().ChoreTypes.Depressurize, this);
