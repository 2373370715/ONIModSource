...
public class FallMonitor : GameStateMachine<FallMonitor, FallMonitor.Instance>
{
	...
	public new class Instance : GameInstance
	{
		...
		public void RecoverEmote()
		{
			...
			{
				new EmoteChore(base.master.GetComponent<ChoreProvider>(), Db.Get().ChoreTypes.EmoteHighPriority, Db.Get().Emotes.Minion.CloseCall_Fall, KAnim.PlayMode.Once, 1, flipRecoverEmote);
			}
		}
