...
public class DehydratedMushroomWrapConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject gameObject = EntityTemplates.CreateLooseEntity(ID.Name, ITEMS.FOOD.MUSHROOMWRAP.DEHYDRATED.NAME, ITEMS.FOOD.MUSHROOMWRAP.DEHYDRATED.DESC, 1f, unitMass: true, anim, "idle", Grid.SceneLayer.BuildingFront, EntityTemplates.CollisionShape.RECTANGLE, 0.6f, 0.7f, isPickupable: true, 0, SimHashes.Polypropylene);
