...
public class CODEX
{
	...
	public class STORY_TRAITS
	{
		...
		public class CRITTER_MANIPULATOR
		{
			...
			public class UNLOCK_SPECIES_NOTIFICATION
			{
				...
				public static LocString TOOLTIP = string.Concat("The ", BUILDINGS.PREFABS.GRAVITASCREATUREMANIPULATOR.NAME, " has analyzed these critter species:\n");
			}
		...
		public static class MORB_ROVER_MAKER
		{
			public class UI_SIDESCREENS
			{
				...
				public static LocString DROP_INVENTORY_TOOLTIP = "Empties stored " + UI.FormatAsLink("Steel", "STEEL") + "\n\nDisabling the building will also prevent " + UI.FormatAsLink("Steel", "STEEL") + " from being delivered";
			...
			public class STATUSITEMS
			{
				...
				public class NOGERMSCONSUMEDALERT
				{
					...
					public static LocString TOOLTIP = string.Concat("This building requires additional {0} in order to function\n\n{0} can be delivered via ", BUILDINGS.PREFABS.GASCONDUIT.NAME, " ");
				}
	...
	public class QUESTS
	{
		...
		public class CRITERIA
		{
			...
			public class DECOR
			{
				...
				public static LocString TOOLTIP = "Establish average " + UI.PRE_KEYWORD + "Decor" + UI.PST_KEYWORD + " of {0} or higher for the area surrounding this building\n\nAverage Decor: {1:0.##}";
			}
			...
			public class SUPPLIEDPOWER
			{
				...
				public static LocString TOOLTIP = "Connect this building to " + UI.PRE_KEYWORD + "Power" + UI.PST_KEYWORD + " long enough to cheer up its occupant\n\nTime Remaining: {0}s";
			}
			...
			public class FOODQUALITY
			{
				...
				public static LocString TOOLTIP = "Deliver 3 unique " + UI.PRE_KEYWORD + "Food" + UI.PST_KEYWORD + " items. Quality must be {0} or higher\n\nFoods Delivered:\n{1}";
			...
			public class LOSTROCKFOSSIL
			{
				...
				public static LocString TOOLTIP = "Retrieve a piece of the ancient critter that has been preserved in " + UI.PRE_KEYWORD + "Rock" + UI.PST_KEYWORD + " ";
	...
	public class ROOM_REQUIREMENT_CLASS
	{
		...
		public class DECORATION
		{
			...
			public static LocString ROOMSREQUIRING = "    • " + UI.FormatAsLink("Luxury Barracks", "BEDROOM") + "\n    • " + UI.FormatAsLink("Private Bedroom", "PRIVATE BEDROOM") + "\n    • " + UI.FormatAsLink("Great Hall", "GREATHALL") + "\n    • " + UI.FormatAsLink("Massage Clinic", "MASSAGECLINIC") + "\n    • " + UI.FormatAsLink("Recreation Room", "REC_ROOM");
		}
	...
	public class BASIC_FABRIC
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "A ball of raw cellulose harvested from a " + UI.FormatAsLink("Thimble Reed", "BASICFABRICPLANT") + ".\n\nIt is used in the production of " + UI.FormatAsLink("Clothing", "EQUIPMENT") + " and textiles.";
		}
	...
	public class LUMBER
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "Thick logs of " + UI.FormatAsLink("Wood", "WOOD") + " harvested from " + UI.FormatAsLink("Arbor Trees", "FOREST_TREE") + ", " + UI.FormatAsLink("Oakshells", "CRABWOOD") + " and other natural sources.\n\nWood Logs are used in the production of " + UI.FormatAsLink("Heat", "HEAT") + " and " + UI.FormatAsLink("Power", "POWER") + ". They are also a useful building material.";
		}
	...
	public class BLUE_GRASS
	{
		public class BODY
		{
			public static LocString CONTAINER1 = "The Alveo Vera's fleshy stems are dotted with small apertures featuring bidirectional valves through which " + UI.FormatAsLink("Carbon Dioxide", "CARBONDIOXIDE") + " is absorbed and sticky oxygenated waste is secreted.\n\nThis buildup resulting from this respiration cycle crystallizes into " + UI.FormatAsLink("Oxylite", "OXYROCK") + " ore.\n\nHorticulturists have long been curious about the protective epithelium that prevents the " + UI.FormatAsLink("Oxylite", "OXYROCK") + " ore from sublimating while on the plant. Unfortunately, it is too fragile to survive handling, and has thus far proven impossible to study.";
		}
