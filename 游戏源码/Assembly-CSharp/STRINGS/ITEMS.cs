...
public class ITEMS
{
	...
	public class FOOD
	{
		...
		public class PANCAKES
		{
			...
			public static LocString DESC = "Sweet discs made from " + UI.FormatAsLink("Raw Egg", "RAWEGG") + " and " + UI.FormatAsLink("Sleet Wheat Grain", "COLDWHEATSEED") + ".\n\nThey're so thick!";

			public static LocString RECIPEDESC = "Sweet discs made from " + UI.FormatAsLink("Raw Egg", "RAWEGG") + " and " + UI.FormatAsLink("Sleet Wheat Grain", "COLDWHEATSEED") + ".";
		}
		...
		public class DEEPFRIEDNOSH
		{
			...
			public static LocString RECIPEDESC = "A crunchy stack of " + UI.FormatAsLink("Nosh Beans", "BEAN_PLANT") + " deep-fried in " + UI.FormatAsLink("Tallow", "TALLOW") + ".";
		}
