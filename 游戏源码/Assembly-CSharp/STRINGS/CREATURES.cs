...
public class CREATURES
{
	...
	public class SPECIES
	{
		...
		public class STATERPILLAR
		{
			...
			public class VARIANT_GAS
			{
				...
				public static LocString DESC = "Smog Slugs are porous creatures that draw in unbreathable " + UI.FormatAsLink("Gases", "ELEMENTS_GAS") + " during the day.\n\nAt night, they sleep near exposed " + UI.FormatAsLink("Gas Pipes,", "GASCONDUIT") + " where they deposit their cache.";
		...
		public class WOODDEER
		{
			...
			public static LocString DESC = "Floxes are nonhostile critters that graze on live and fallen " + UI.FormatAsLink("Pikeapples", "HARDSKINBERRY") + ".\n\nWhen Flox antlers are fully grown, they harden into shearable " + UI.FormatAsLink("Wood", "WOOD") + ".";
		...
		public class ICEBELLY
		{
			...
			public static LocString DESC = string.Concat("Bammoths are lumbering, nonhostile creatures that subsist on ", UI.FormatAsLink("Plume Squash", "CARROT"), ".\n\nTheir thick overcoats can be shorn for ", ITEMS.INDUSTRIAL_PRODUCTS.BASIC_FABRIC.NAME, ".");
		...
		public class SEAL
		{
			...
			public static LocString DESC = string.Concat("Spigot Seals are charismatic creatures who produce ", UI.FormatAsLink("Ethanol", "ETHANOL"), ".\n\nThey enjoy sipping ", ELEMENTS.SUGARWATER.NAME, " straight from the ", UI.FormatAsLink("Bonbon Tree", "SPACETREE"), ".");
		...
		public class MOO
		{
			...
			public static LocString DESC = string.Concat("Moos are extraterrestrial critters that feed on ", UI.FormatAsLink("Gas Grass", "GASGRASS"), " and excrete ", UI.FormatAsLink("Natural Gas", "METHANE"), ".\n\nWhen domesticated and fed, they can be milked for ", ELEMENTS.MILK.NAME, ".");
		}
		...
		public class MOLE
		{
			...
			public class VARIANT_DELICACY
			{
				...
				public static LocString DESC = "Delecta Voles are burrowing critters whose bodies sprout shearable " + UI.FormatAsLink("Tonic Root", "GINGERCONFIG") + " when " + UI.FormatAsLink("Regolith", "REGOLITH") + " is ingested at preferred temperatures.\n\nThey cannot burrow through " + UI.FormatAsLink("Refined Metals", "REFINEDMETAL") + ".";
		...
		public class PINKROCKCARVED
		{
			...
			public static LocString DESC = "A Duplicant has carved this Lumen quartz in a way that really maximizes its " + UI.FormatAsLink("Decor", "DECOR") + " value and " + UI.FormatAsLink("brightness", "LIGHT") + ".";
		...
		public class ICEFLOWER
		{
			...
			public static LocString DESC = "Idyllas are " + UI.FormatAsLink("Decorative", "DECOR") + " " + UI.FormatAsLink("Plants", "PLANTS") + " with soft, pompom-shaped blossoms.\n\nGazing dreamily at them has a positive effect on " + UI.FormatAsLink("Morale", "MORALE") + ".";
		...
		public class HARDSKINBERRYPLANT
		{
			...
			public static LocString DESC = string.Concat("Pikeapple bushes produce ", ITEMS.FOOD.HARDSKINBERRY.NAME, ", a useful yet almost unbearably fragrant ", UI.FormatAsLink("Food", "FOOD"), ".");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces edible ", ITEMS.FOOD.HARDSKINBERRY.NAME, ".");
		}
		...
		public class CARROTPLANT
		{
			...
			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces edible ", ITEMS.FOOD.CARROT.NAME, ".");
		}
		...
		public class SPACETREE
		{
			...
			public static LocString DESC = string.Concat("Bonbon Tree branches synthesize ", UI.FormatAsLink("Light", "LIGHT"), " to produce ", ELEMENTS.SUGARWATER.NAME, ".\n\nBranches can be harvested for ", ELEMENTS.WOODLOG.NAME, ".\n\nBonbon Trees can shed most environmental debris, and rarely become entombed.");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ELEMENTS.SUGARWATER.NAME, " and ", ELEMENTS.WOODLOG.NAME, ".");
		}
		...
		public class BLUE_GRASS
		{
			...
			public static LocString DESC = string.Concat("Alveo Veras consume ", ELEMENTS.CARBONDIOXIDE.NAME, " and ", ELEMENTS.ICE.NAME, ", and form harvestable ", ELEMENTS.OXYROCK.NAME, " deposits.");

			public static LocString DOMESTICATEDDESC = string.Concat("This plant produces ", ELEMENTS.OXYROCK.NAME, ".");
		}
		...
		public class SALTPLANT
		{
			...
			public static LocString DESC = "Dasha Saltvines consume small amounts of " + UI.FormatAsLink("Chlorine Gas", "CHLORINEGAS") + " and form sodium deposits as they grow, producing harvestable " + UI.FormatAsLink("Salt", "SALT") + ".";
		...
		public class OXYFERN
		{
			...
			public static LocString DESC = "Oxyferns absorb " + UI.FormatAsLink("Carbon Dioxide Gas", "CARBONDIOXIDE") + " and exude breathable " + UI.FormatAsLink("Oxygen", "OXYGEN") + ".";

			public static LocString DOMESTICATEDDESC = "This plant converts " + UI.FormatAsLink("Carbon Dioxide", "CARBONDIOXIDE") + " into " + UI.FormatAsLink("Oxygen", "OXYGEN") + ".";
		}
		...
		public class WOOD_TREE
		{
			...
			public static LocString DESC = "Arbor Trees grow " + UI.FormatAsLink("Arbor Tree Branches", "FOREST_TREE") + " and can be harvested for " + UI.FormatAsLink("Wood", "WOOD") + ".";

			public static LocString DOMESTICATEDDESC = "This plant produces " + UI.FormatAsLink("Arbor Tree Branches", "FOREST_TREE") + " that can be harvested for " + UI.FormatAsLink("Wood", "WOOD") + ".";
		}
		...
		public class SEEDS
		{
			...
			public class ICEFLOWER
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of an ", SPECIES.ICEFLOWER.NAME, ".\n\nDigging up Buried Objects may uncover an Idylla Seed.");
			}
			...
			public class HARDSKINBERRYPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.HARDSKINBERRYPLANT.NAME, ".\n\nDigging up Buried Objects may uncover a Pikeapple Bush Seed.");
			}
			...
			public class SPACETREE
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.SPACETREE.NAME, ".\n\nDigging up Buried Objects may uncover a Bonbon Tree Seed.");
			}
			...
			public class BLUE_GRASS
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.BLUE_GRASS.NAME, ".\n\nDigging up Buried Objects may uncover an Alveo Vera Seed.");
			}
			...
			public class CARROTPLANT
			{
				...
				public static LocString DESC = string.Concat("The ", UI.FormatAsLink("Seed", "PLANTS"), " of a ", SPECIES.CARROTPLANT.NAME, ".\n\nDigging up Buried Objects may uncover a Plume Squash Seed.");
			}
	...
	public class STATUSITEMS
	{
		...
		public class LOOKINGFORLIQUID
		{
			...
			public static LocString TOOLTIP = "This critter is looking for " + UI.PRE_KEYWORD + "Liquids" + UI.PST_KEYWORD + " to mop up";
		}
		...
		public class LOOKINGFORGAS
		{
			...
			public static LocString TOOLTIP = "This critter is on the lookout for unbreathable " + UI.PRE_KEYWORD + "Gases" + UI.PST_KEYWORD + " to collect";
		}
		...
		public class SCOLDING
		{
			...
			public static LocString TOOLTIP = "Current external " + UI.PRE_KEYWORD + "Temperature" + UI.PST_KEYWORD + " is perilously low [<b>{ExternalTemperature}</b> / <b>{TargetTemperature}</b>]";

			public static LocString NOTIFICATION_NAME = "Frostbite";

			public static LocString NOTIFICATION_TOOLTIP = "Extremely Low " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " are hurting these Duplicants:";
		}
		...
		public class WRONGIRRIGATIONMAJOR
		{
			...
			public static LocString TOOLTIP = "This farm is storing " + UI.PRE_KEYWORD + "Liquids" + UI.PST_KEYWORD + " that are not suitable for this plant\n\n" + UI.PRE_KEYWORD + "Empty Storage" + UI.PST_KEYWORD + " on this building to remove the unusable liquids";
		...
		public class SUGARWATERPRODUCTIONWILTED
		{
			...
			public static LocString TOOLTIP = "This plant is wilted\n\n" + UI.PRE_KEYWORD + "Nectar" + UI.PST_KEYWORD + " production will resume when conditions improve";
		}
		...
		public class SPACETREEBRANCHLIGHTSTATUS
		{
			...
			public static LocString TOOLTIP = "The selected branch's " + UI.PRE_KEYWORD + "Light" + UI.PST_KEYWORD + " exposure contributes to this plant's total " + UI.PRE_KEYWORD + "Nectar" + UI.PST_KEYWORD + " production\n\nOptimal lux: {0}\n\nCurrent lux: {1}";
		}
		...
		public class BECKONING
		{
			...
			public static LocString TOOLTIP = "This critter is inviting faraway friends to graze on this asteroid's abundant food supply\n\nA new " + UI.PRE_KEYWORD + "Gassy Moo" + UI.PST_KEYWORD + " will soon arrive";
		}
		...
		public class MILKFULL
		{
			...
			public static LocString TOOLTIP = "This critter is full of " + UI.PRE_KEYWORD + "Brackene" + UI.PST_KEYWORD + " and ready to be milked";
		}
	...
	public class STATS
	{
		...
		public class CRITTERTEMPERATURE
		{
			...
			public static LocString TOOLTIP = "This critter's comfortable " + UI.PRE_KEYWORD + "Body Temperature" + UI.PST_KEYWORD + " range is between <b>{0}</b> and <b>{1}</b>";
		}
		...
		public class BECKONING
		{
			...
			public static LocString TOOLTIP = "At 100% " + UI.PRE_KEYWORD + "Accu-moo-lation" + UI.PST_KEYWORD + ", a Gassy Moo calls a friend to join them on this asteroid\n\nAfter the new Gassy Moo has landed, " + UI.PRE_KEYWORD + "Accu-moo-lation" + UI.PST_KEYWORD + " is rolled back to 0%";
		}
	...
	public class ATTRIBUTES
	{
		...
		public class MILKPRODUCTIONDELTA
		{
			...
			public static LocString TOOLTIP = "Determines how long this " + UI.PRE_KEYWORD + "Critter" + UI.PST_KEYWORD + " takes to replenish its natural supply of " + UI.PRE_KEYWORD + "Brackene" + UI.PST_KEYWORD + ".";
		}
	...
	public class MODIFIERS
	{
		...
		public class GOTMILK
		{
			...
			public static LocString TOOLTIP = "This critter recently drank " + UI.PRE_KEYWORD + "Brackene" + UI.PST_KEYWORD + "\n\nIt doesn't mind overcrowding quite as much right now";
		}
		...
		public class FUTURE_OVERCROWDED
		{
			...
			public static LocString TOOLTIP = "This " + UI.PRE_KEYWORD + "Room" + UI.PST_KEYWORD + " will become too crowded once all nearby " + UI.PRE_KEYWORD + "Eggs" + UI.PST_KEYWORD + " hatch\n\nThe selected critter has slowed its " + UI.PRE_KEYWORD + "Reproduction" + UI.PST_KEYWORD + " to prevent further overpopulation";
		}
		...
		public class MOOWELLFED
		{
			...
			public static LocString TOOLTIP = "This critter's recent meal is boosting their " + UI.PRE_KEYWORD + "Brackene" + UI.PST_KEYWORD + " supply and making them wish all their friends were here\n\nThey're thinking about calling a new Gassy Moo to this asteroid";
		}
