...
public class DUPLICANTS
{
	...
	public class CHORES
	{
		...
		public class ANALYZESEED
		{
			...
			public static LocString TOOLTIP = "This Duplicant is analyzing " + UI.PRE_KEYWORD + "Seeds" + UI.PST_KEYWORD + " to find mutations";
		}
		...
		public class EXCAVATEFOSSIL
		{
			...
			public static LocString TOOLTIP = "This Duplicant is excavating a " + UI.PRE_KEYWORD + "Fossil" + UI.PST_KEYWORD + " site";
		}
	...
	public class STATUSITEMS
	{
		public class WAXEDFORTRANSITTUBE
		{
			...
			public static LocString TOOLTIP = string.Concat("This Duplicant slapped on some ", ELEMENTS.MILKFAT.NAME, " before starting their commute\n\nThis boosts their ", BUILDINGS.PREFABS.TRAVELTUBE.NAME, " travel speed by {0}");
		}
		...
		public class SLEEPINGEXHAUSTED
		{
			...
			public static LocString TOOLTIP = "Cold " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " or lack of rest depleted this Duplicant's " + UI.PRE_KEYWORD + "Stamina" + UI.PST_KEYWORD + "\n\nThey didn't have enough energy to make it to bedtime";
		}
		...
		public class EXITINGCOLD
		{
			...
			public static LocString TOOLTIP = "This Duplicant was recently exposed to cold " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " and wants to warm up\n\nWithout a warming station, it will take {0} for them to recover\n\nStress: <b>{StressModification}</b>\nStamina: <b>{StaminaModification}</b>\nAthletics: <b>{AthleticsModification}</b>";
		}
		...
		public class EXITINGHOT
		{
			...
			public static LocString TOOLTIP = "This Duplicant was recently exposed to hot " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " and wants to cool down\n\nWithout a cooling station, it will take {0} for them to recover\n\nStress: <b>{StressModification}</b>\nStamina: <b>{StaminaModification}</b>\nAthletics: <b>{AthleticsModification}</b>";
		}
		...
		public class STRESS_SIGNAL_VOMITER
		{
			...
			public static LocString TOOLTIP = "Sort of like having butterflies in your stomach, except they're burps\n\nImprove this Duplicant's " + UI.PRE_KEYWORD + "Morale" + UI.PST_KEYWORD + " before they start to stress vomit";
		}
		...
		public class METEORPHILE
		{
			...
			public static LocString TOOLTIP = "This Duplicant is <i>really</i> into meteor showers\n• All " + UI.PRE_KEYWORD + "Attributes" + UI.PST_KEYWORD + " <b>+3</b> during meteor showers";
		}
		...
		public class NOTOILETS
		{
			...
			public static LocString TOOLTIP = "There are no " + UI.FormatAsLink("Outhouses", "OUTHOUSE") + " available for this Duplicant\n\n" + UI.FormatAsLink("Outhouses", "OUTHOUSE") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5);

			public static LocString NOTIFICATION_NAME = "No Outhouses built";

			public static LocString NOTIFICATION_TOOLTIP = UI.FormatAsLink("Outhouses", "OUTHOUSE") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5) + ".\n\nThese Duplicants are in need of an " + UI.FormatAsLink("Outhouse", "OUTHOUSE") + ":";
		}
		...
		public class STRESSFULLYEMPTYINGBLADDER
		{
			...
			public static LocString TOOLTIP = "This poor Duplicant couldn't find an " + UI.FormatAsLink("Outhouse", "OUTHOUSE") + " in time and is super embarrassed\n\n" + UI.FormatAsLink("Outhouses", "OUTHOUSE") + " can be built from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5);

			public static LocString NOTIFICATION_NAME = "Made a mess";

			public static LocString NOTIFICATION_TOOLTIP = "The " + UI.FormatAsTool("Mop Tool", Action.Mop) + " can be used to clean up Duplicant-related \"spills\"\n\nThese Duplicants made messes that require cleaning up:\n";
		}
		...
		public class VOMITING
		{
			...
			public static LocString TOOLTIP = "This Duplicant has unceremoniously hurled as the result of a " + UI.FormatAsLink("Disease", "DISEASE") + "\n\nDuplicant-related \"spills\" can be cleaned up using the " + UI.PRE_KEYWORD + "Mop Tool" + UI.PST_KEYWORD + " " + UI.FormatAsHotKey(Action.Mop);
		...
		public class STRESSVOMITING
		{
			...
			public static LocString TOOLTIP = "This Duplicant is relieving their " + UI.PRE_KEYWORD + "Stress" + UI.PST_KEYWORD + " all over the floor\n\nDuplicant-related \"spills\" can be cleaned up using the " + UI.PRE_KEYWORD + "Mop Tool" + UI.PST_KEYWORD + " " + UI.FormatAsHotKey(Action.Mop);

			public static LocString NOTIFICATION_NAME = "Stress vomiting";

			public static LocString NOTIFICATION_TOOLTIP = "The " + UI.FormatAsTool("Mop Tool", Action.Mop) + " can used to clean up Duplicant-related \"spills\"\n\nThese Duplicants became so " + UI.PRE_KEYWORD + "Stressed" + UI.PST_KEYWORD + " they threw up:";
		}
		...
		public class RADIATIONVOMITING
		{
			...
			public static LocString TOOLTIP = "This Duplicant is sick due to " + UI.PRE_KEYWORD + "Radiation" + UI.PST_KEYWORD + " poisoning.\n\nDuplicant-related \"spills\" can be cleaned up using the " + UI.PRE_KEYWORD + "Mop Tool" + UI.PST_KEYWORD + " " + UI.FormatAsHotKey(Action.Mop);

			public static LocString NOTIFICATION_NAME = "Radiation vomiting";

			public static LocString NOTIFICATION_TOOLTIP = "The " + UI.FormatAsTool("Mop Tool", Action.Mop) + " can clean up Duplicant-related \"spills\"\n\nRadiation Sickness caused these Duplicants to throw up:";
		}
	...
	public class DISEASES
	{
		...
		public class DESCRIPTORS
		{
			public class INFO
			{
				...
				public static LocString TEMPERATURE_RANGE_TOOLTIP = "These " + UI.PRE_KEYWORD + "Germs" + UI.PST_KEYWORD + " can survive " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " between <b>{0}</b> and <b>{1}</b>\n\nThey thrive in " + UI.PRE_KEYWORD + "Temperatures" + UI.PST_KEYWORD + " between <b>{2}</b> and <b>{3}</b>";

				public static LocString PRESSURE_RANGE = "Pressure range: {0} to {1}\n";

				public static LocString PRESSURE_RANGE_TOOLTIP = "These " + UI.PRE_KEYWORD + "Germs" + UI.PST_KEYWORD + " can survive between <b>{0}</b> and <b>{1}</b> of pressure\n\nThey thrive in pressures between <b>{2}</b> and <b>{3}</b>";
			}
		}
		...
		public class SLIMELUNG
		{
			...
			public static LocString DESC = "Slimelung germs are found in " + UI.FormatAsLink("Slime", "SLIMEMOLD") + " and " + UI.FormatAsLink("Polluted Oxygen", "CONTAMINATEDOXYGEN") + ". Inhaling these germs can cause Duplicants to cough and struggle to breathe.";
		}
		...
		public class RADIATIONPOISONING
		{
			...
			public static LocString DESC = "Items tainted with Radioactive Contaminants emit low levels of " + UI.FormatAsLink("Radiation", "RADIATION") + " that can cause " + UI.FormatAsLink("Radiation Sickness", "RADIATIONSICKNESS") + ". They are unaffected by pressure or temperature, but do degrade over time.";
		}
		...
		public class RADIATIONSICKNESS
		{
			...
			public static LocString DESC = RADIATIONPOISONING.DESC;
		}
	...
	public class MODIFIERS
	{
		...
		public class ROOMBEDROOM
		{
			...
			public static LocString TOOLTIP = "This Duplicant slept in a " + UI.PRE_KEYWORD + "Luxury Barracks" + UI.PST_KEYWORD + " last night and feels extra refreshed";
		}
		...
		public class ROOMPRIVATEBEDROOM
		{
			...
			public static LocString TOOLTIP = "This Duplicant slept in a " + UI.PRE_KEYWORD + "Private Bedroom" + UI.PST_KEYWORD + " last night and feels super refreshed";
		}
		...
		public class WARMTOUCH
		{
			...
			public static LocString PROVIDERS_TOOLTIP = "Using this building provides temporary immunity to " + UI.PRE_KEYWORD + "Chilly Surroundings" + UI.PST_KEYWORD + " and " + UI.PRE_KEYWORD + "Soggy Feet" + UI.PST_KEYWORD;
		}
		...
		public class DUPLICANTGOTMILK
		{
			...
			public static LocString TOOLTIP = "This Duplicant recently drank " + UI.PRE_KEYWORD + "Brackene" + UI.PST_KEYWORD + ". It's helping them relax";
		}
		...
		public class WARMTOUCHFOOD
		{
			...
			public static LocString DESCRIPTION = "Eating this provides temporary immunity to " + UI.PRE_KEYWORD + "Chilly Surroundings" + UI.PST_KEYWORD + " and " + UI.PRE_KEYWORD + "Soggy Feet" + UI.PST_KEYWORD;
		}
		...
		public class SEAFOODRADIATIONRESISTANCE
		{
			...
			public static LocString TOOLTIP = "This Duplicant ate sea-grown foods, which boost " + UI.PRE_KEYWORD + "Radiation" + UI.PST_KEYWORD + " resistance";
		...
		public class SLEEPCLINIC
		{
			...
			public static LocString TOOLTIP = "This Duplicant is losing " + UI.PRE_KEYWORD + "Stamina" + UI.PST_KEYWORD + " because of their " + UI.PRE_KEYWORD + "Pajamas" + UI.PST_KEYWORD;
		}
		...
		public class MEGABRAINTANKBONUS
		{
			...
			public static LocString TOOLTIP = "This Duplicant is smarter and stronger than usual thanks to the " + UI.PRE_KEYWORD + "Somnium Synthesizer" + UI.PST_KEYWORD + " ";
		}
		...
		public class POWERTINKER
		{
			...
			public static LocString TOOLTIP = string.Concat("A skilled Duplicant has improved this generator's ", UI.PRE_KEYWORD, "Power", UI.PST_KEYWORD, " output efficiency\n\nApplying this effect consumed one ", UI.PRE_KEYWORD, ITEMS.INDUSTRIAL_PRODUCTS.POWER_STATION_TOOLS.NAME, UI.PST_KEYWORD);
		}
		...
		public class FARMTINKER
		{
			...
			public static LocString TOOLTIP = string.Concat("A skilled Duplicant has encouraged this ", UI.PRE_KEYWORD, "Plant", UI.PST_KEYWORD, " to grow a little bit faster\n\nApplying this effect consumed one dose of ", UI.PRE_KEYWORD, ITEMS.INDUSTRIAL_PRODUCTS.FARM_STATION_TOOLS.NAME, UI.PST_KEYWORD);
		}
		...
		public class THRIVER
		{
			...
			public static LocString TOOLTIP = "This Duplicant is " + UI.PRE_KEYWORD + "Stressed" + UI.PST_KEYWORD + " and has kicked into hyperdrive";
		}
		...
		public class WAILEDAT
		{
			...
			public static LocString TOOLTIP = "This Duplicant is feeling " + UI.PRE_KEYWORD + "Stressed" + UI.PST_KEYWORD + " by someone's Banshee Wail";
		}
	...
	public class TRAITS
	{
		public class CHATTY
		{
			...
			public static LocString DESC = "This Duplicant's so charming, chatting with them is sometimes enough to trigger an " + UI.PRE_KEYWORD + "Overjoyed" + UI.PST_KEYWORD + " response";
		}
		...
		{
			public static LocString NAME = string.Concat(GRANTED_SKILL_SHARED_NAME, ROLES.PYROTECHNIC.NAME);

			public static LocString DESC = ROLES.PYROTECHNIC.DESCRIPTION;
	...
	public class ATTRIBUTES
	{
		...
		public class SCOLDINGTHRESHOLD
		{
			...
			public static LocString DESC = "Determines the " + UI.PRE_KEYWORD + "Temperature" + UI.PST_KEYWORD + " at which a Duplicant will get frostbitten.";
		}
		...
		public class TRANSITTUBETRAVELSPEED
		{
			...
			public static LocString DESC = string.Concat("Determines a Duplicant's default ", BUILDINGS.PREFABS.TRAVELTUBE.NAME, " travel speed.");
		...
		public class METABOLISM
		{
			...
			public static LocString DESC = "Affects the rate at which a critter burns " + UI.PRE_KEYWORD + "Calories" + UI.PST_KEYWORD + " and produces materials";
		}
		...
		public static LocString PROFESSION_DESC = "Expertise is determined by a Duplicant's highest " + UI.PRE_KEYWORD + "Attribute" + UI.PST_KEYWORD + "\n\nDuplicants develop higher expectations as their Expertise level increases";
	...
	public class ROLES
	{
		...
		public class PYROTECHNIC
		{
			...
			public static LocString DESCRIPTION = "Allows a Duplicant to make " + UI.PRE_KEYWORD + "Blastshot" + UI.PST_KEYWORD + " for the " + UI.PRE_KEYWORD + "Meteor Blaster" + UI.PST_KEYWORD;
		}
