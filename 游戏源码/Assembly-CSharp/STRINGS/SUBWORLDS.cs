...
public class SUBWORLDS
{
	...
	public static class JUNGLE
	{
		...
		public static LocString DESC = "Initial investigations of the Jungle Biome reveal an ecosystem filled with unique flora but centered around " + UI.FormatAsLink("Liquid Chlorine", "CHLORINE") + " and " + UI.FormatAsLink("Hydrogen Gas", "HYDROGEN") + " gas, toxic to Duplicants. When exploring here, it is worth setting up a good system.";
