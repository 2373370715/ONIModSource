...
public class COLONY_ACHIEVEMENTS
{
	...
	public class ACTIVATEGEOTHERMALPLANT
	{
		public class SIDESCREENS
		{
			...
			public static LocString BRING_CONTROLLER_ONLINE_TOOLTIP = "Reconnect this building's " + UI.PRE_KEYWORD + "Steel" + UI.PST_KEYWORD + " pipes to restore functionality\n\nClick to show this building";

			public static LocString UTILIZE_GEOPLANT_TITLE = "Complete Inaugural Run";

			public static LocString UTILIZE_GEOPLANT_DESC = "Successfully heat a " + UI.PRE_KEYWORD + "Liquid" + UI.PST_KEYWORD + " via the geothermal heat pump for the first time";
		}
		...
		public class STATUSITEMS
		{
			public class VENT
			{
				...
				public static LocString QUEST_BLOCKED_TOOLTIP = "This geo vent is currently obstructed by a " + UI.PRE_KEYWORD + "Lead" + UI.PST_KEYWORD + " mass\n\nIt will become usable once the obstruction has been cleared by piping in liquids hot enough to melt it";
				...
				public static LocString OVERPRESSURE_TOOLTIP = "High " + UI.PRE_KEYWORD + "Liquid" + UI.PST_KEYWORD + " or " + UI.PRE_KEYWORD + "Gas" + UI.PST_KEYWORD + " pressure in this area is preventing further emissions\n\nReduce pressure by pumping " + UI.PRE_KEYWORD + "Liquids" + UI.PST_KEYWORD + " or " + UI.PRE_KEYWORD + "Gases" + UI.PST_KEYWORD + " away or clearing more space\n\nClick here to show this vent";

				public static LocString BLOCKED_NAME = "Blocked";

				public static LocString BLOCKED_TOOLTIP = "A " + UI.PRE_KEYWORD + "Pipe" + UI.PST_KEYWORD + " has been obstructed and is preventing " + UI.PRE_KEYWORD + "Liquids" + UI.PST_KEYWORD + " or " + UI.PRE_KEYWORD + "Gases" + UI.PST_KEYWORD + " from flowing to this geo vent";
			...
			public class CONTROLLER
			{
				...
				public static LocString STORAGE_TEMPERATURE_TOOLTIP = "The average " + UI.PRE_KEYWORD + "Temperature" + UI.PST_KEYWORD + " of " + UI.PRE_KEYWORD + "Liquids" + UI.PST_KEYWORD + " stored in this building is {Temp}\n\nThe initial input " + UI.PRE_KEYWORD + "Temperature" + UI.PST_KEYWORD + " determines the type of materials emitted";
		...
		public class BUTTONS
		{
			...
			public static LocString REPAIR_CONTROLLER_TOOLTIP = "Reconnect this building's  " + UI.PRE_KEYWORD + "Steel" + UI.PST_KEYWORD + " plumbing system to restore function";
			...
			public static LocString INITIATE_FIRST_VENT_READY_TOOLTIP = "Release " + UI.PRE_KEYWORD + "Liquids" + UI.PST_KEYWORD + " from the geothermal heat pump to the geo vents for the first time";
		...
		public class REQUIREMENTS
		{
			...
			public static LocString ACTIVATE_PLANT_DESCRIPTION = "Pump " + UI.PRE_KEYWORD + "liquids" + UI.PST_KEYWORD + " from the Geothermal Heat Pump into the Geo Vents";
