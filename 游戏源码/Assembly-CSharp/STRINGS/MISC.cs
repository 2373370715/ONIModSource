...
public class MISC
{
	public class TAGS
	{
		...
		public static LocString BUILDABLERAW_DESC = "Raw minerals are the unrefined forms of organic solids. Almost all raw minerals can be processed in the " + UI.FormatAsLink("Rock Crusher", "ROCKCRUSHER") + ", although a handful require the use of the " + UI.FormatAsLink("Molecular Forge", "SUPERMATERIALREFINERY") + ".";
		...
		public static LocString PLASTIFIABLELIQUID_DESC = "Plastic monomers are organic compounds that can be processed into " + UI.FormatAsLink("Plastics", "PLASTIC") + " that have valuable applications as advanced building materials. Plastics derived from these monomers can also be used as packaging materials for " + UI.FormatAsLink("Food", "FOOD") + " preservation.";
		...
		public static LocString METAL_DESC = "Metal ore is the raw form of metal, and has a wide variety of practical applications in electronics and general construction.\n\nMetal ore is typically processed into " + UI.FormatAsLink("Refined Metal", "REFINEDMETAL") + " using the " + UI.FormatAsLink("Rock Crusher", "ROCKCRUSHER") + " or the " + UI.FormatAsLink("Metal Refinery", "METALREFINERY") + ".\n\nSome rare metal ores can also be refined in the " + UI.FormatAsLink("Molecular Forge", "SUPERMATERIALREFINERY") + ".";
		...
		public static LocString BUILDINGWOOD_DESC = "Wood is a renewable building material which can also be used as a valuable source of fuel and electricity when refined at the " + UI.FormatAsLink("Wood Burner", "WOODGASGENERATOR") + " or the " + UI.FormatAsLink("Ethanol Distiller", "ETHANOLDISTILLERY") + ".";
		...
		public static LocString PLASTIC_DESC = "Plastics are synthetic " + UI.FormatAsLink("Solids", "ELEMENTSSOLID") + " that are pliable and minimize the transfer of " + UI.FormatAsLink("Heat", "Heat") + ". They typically have a low melting point, although more advanced plastics have been developed to circumvent this issue.";
		...
		public static LocString TRANSPARENT_DESC = "Transparent materials allow " + UI.FormatAsLink("Light", "LIGHT") + " to pass through. Illumination boosts Duplicant productivity during working hours, but undermines sleep quality.\n\nTransparency is also important for buildings that require a clear line of sight in order to function correctly, such as the " + UI.FormatAsLink("Space Scanner", "COMETDETECTOR") + ".";
		...
		public static LocString COMBUSTIBLELIQUID_DESC = "Combustible Liquids are liquids that can be burned as fuel to be used in energy production such as in a " + UI.FormatAsLink("Petroleum Generator", "PETROLEUMGENERATOR") + " or a " + UI.FormatAsLink("Petroleum Engine", "KEROSENEENGINE") + ".\n\nThough these liquids have other uses, such as fertilizer for growing a " + UI.FormatAsLink("Nosh Bean", "BEANPLANTSEED") + ", their primary usefulness lies in their ability to be burned for " + UI.FormatAsLink("power", "POWER") + ".";
	...
	public class STATUSITEMS
	{
		...
		public class REHYDRATEDFOOD
		{
			...
			public static LocString TOOLTIP = string.Format("This food has been carefully re-moistened for consumption\n\n" + UI.PRE_KEYWORD + "{1}" + UI.PST_KEYWORD + ": {0}", -1f, UI.FormatAsLink(DUPLICANTS.ATTRIBUTES.QUALITYOFLIFE.NAME, DUPLICANTS.ATTRIBUTES.QUALITYOFLIFE.NAME));
		}
		...
		public class NOTMARKEDFORHARVEST
		{
			...
			public static LocString TOOLTIP = "Use the " + UI.FormatAsTool("Harvest Tool", Action.Harvest) + " to mark this plant for harvest";
		}
		...
		public class ORDERCAPTURE
		{
			...
			public static LocString TOOLTIP = string.Concat("Waiting for a Duplicant to capture this ", UI.PRE_KEYWORD, "Critter", UI.PST_KEYWORD, "\n\nOnly Duplicants with the ", DUPLICANTS.ROLES.RANCHER.NAME, " skill can catch critters without traps");
		}
	...
	public class NOTIFICATIONS
	{
		...
		public class WELCOMEMESSAGE
		{
			...
			public static LocString MESSAGEBODY = "I can use the " + UI.FormatAsTool("Dig Tool", Action.Dig) + " and the " + UI.FormatAsBuildMenuTab("Build Menu") + " in the lower left of the screen to begin planning my first construction tasks.\n\nOnce I've placed a few errands my Duplicants will automatically get to work, without me needing to direct them individually.";
		...
		public class FETCHINGWATERMESSAGE
		{
			...
			public static LocString MESSAGEBODY = "By building a " + UI.FormatAsLink("Pitcher Pump", "LIQUIDPUMPINGSTATION") + " from the " + UI.FormatAsBuildMenuTab("Plumbing Tab", Action.Plan5) + " over a pool of liquid, my Duplicants will be able to bottle it up and manually deliver it wherever it needs to go.";
		...
		public class LOTS_OF_GERMS
		{
			...
			public static LocString MESSAGEBODY = UI.FormatAsLink("Germs", "DISEASE") + " such as " + UI.FormatAsLink("Food Poisoning", "FOODSICKNESS") + " and " + UI.FormatAsLink("Slimelung", "SLIMESICKNESS") + " can cause " + UI.FormatAsLink("Disease", "DISEASE") + " in my Duplicants. I can use the " + UI.FormatAsOverlay("Germ Overlay", Action.Overlay9) + " to view all germ concentrations in my colony, and even detect the sources spawning them.\n\nBuilding Wash Basins from the " + UI.FormatAsBuildMenuTab("Medicine Tab", Action.Plan8) + " near colony toilets will tell my Duplicants they need to wash up.\n\nRelated " + UI.FormatAsLink("Video: Plumbing and Ventilation", "VIDEOS18");
		}
