...
public class SpaceDestinationTypes : ResourceSet<SpaceDestinationType>
{
		...
		: base("SpaceDestinations", parent)
	{
		...
		{
			DLC2CeresSpaceDestination = Add(new SpaceDestinationType("DLC2CeresSpaceDestination", parent, UI.SPACEDESTINATIONS.PLANETS.DLC2CERESSPACEDESTINATION.NAME, UI.SPACEDESTINATIONS.PLANETS.DLC2CERESSPACEDESTINATION.DESCRIPTION, 96, "ceres_debris_field", new Dictionary<SimHashes, MathUtil.MinMax>
			{
				{
					SimHashes.Cinnabar,
					new MathUtil.MinMax(100f, 200f)
			...
			}, Db.Get().ArtifactDropRates.Good, 384000000, 383980000, 60));
		}
	}
}
