...
public class Attributes : ResourceSet<Attribute>
{
		...
		: base("Attributes", parent)
	{
		...
		Luminescence = Add(new Attribute("Luminescence", is_trainable: false, Attribute.Display.General, is_profession: false));
		...
		ScoldingThreshold = Add(new Attribute("ScoldingThreshold", is_trainable: false, Attribute.Display.General, is_profession: false));
		ScoldingThreshold.SetFormatter(new StandardAttributeFormatter(GameUtil.UnitClass.Temperature, GameUtil.TimeSlice.None));
		...
		TransitTubeTravelSpeed = Add(new Attribute("TransitTubeTravelSpeed", is_trainable: false, Attribute.Display.Never, is_profession: false));
		TransitTubeTravelSpeed.SetFormatter(new StandardAttributeFormatter(GameUtil.UnitClass.SimpleFloat, GameUtil.TimeSlice.None));
