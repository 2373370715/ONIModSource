...
public class ColonyAchievements : ResourceSet<ColonyAchievement>
{
		...
		: base("ColonyAchievements", parent)
	{
		...
		if (DlcManager.IsExpansion1Active())
		{
			...
			}, COLONY_ACHIEVEMENTS.STUDY_ARTIFACTS.MESSAGE_TITLE, COLONY_ACHIEVEMENTS.STUDY_ARTIFACTS.MESSAGE_BODY, "victoryShorts/Artifact", "victoryLoops/Artifact_loop", ArtifactSequence.Start, AudioMixerSnapshots.Get().VictoryNISGenericSnapshot, "cosmic_archaeology", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID");
		...
		if (DlcManager.GetOwnedDLCIds().Contains("DLC2_ID"))
		{
			...
			}, COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.MESSAGE_TITLE, COLONY_ACHIEVEMENTS.ACTIVATEGEOTHERMALPLANT.MESSAGE_BODY, "victoryShorts/Geothermal", "victoryLoops/Geothermal_loop", GeothermalVictorySequence.Start, AudioMixerSnapshots.Get().VictoryNISGenericSnapshot, "geothermalplant", DlcManager.AVAILABLE_DLC_2, "DLC2_ID", "GeothermalImperative"));
		}
		...
		if (DlcManager.IsExpansion1Active())
		{
			...
			}, "", "", "", "", null, default(EventReference), "first_teleport_of_call", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			{
				new BuildALaunchPad()
			}, "", "", "", "", null, default(EventReference), "soft_launch", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			}, "", "", "", "", null, default(EventReference), "gmo_ok", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			}, "", "", "", "", null, default(EventReference), "mine_the_gap", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			{
				new LandOnAllWorlds()
			}, "", "", "", "", null, default(EventReference), "land_on_all_worlds", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			}, "", "", "", "", null, default(EventReference), "radical_trip", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			}, "", "", "", "", null, default(EventReference), "sweeter_than_honey", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			}, "", "", "", "", null, default(EventReference), "survive_a_rocket", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
			...
			}, "", "", "", "", null, default(EventReference), "thats_rad", DlcManager.AVAILABLE_EXPANSION1_ONLY, "EXPANSION1_ID"));
		}
	}
}
