...
public class ChoreTypes : ResourceSet<ChoreType>
{
		...
		: base("ChoreTypes", parent)
	{
		...
		HealCritical = Add("HealCritical", new string[0], "HealCritical", new string[3] { "Vomit", "Cough", "EmoteHighPriority" }, DUPLICANTS.CHORES.HEAL.NAME, DUPLICANTS.CHORES.HEAL.STATUS, DUPLICANTS.CHORES.HEAL.TOOLTIP, skip_implicit_priority_change: false);
		...
		RecoverWarmth = Add("RecoverWarmth", new string[0], "", new string[0], DUPLICANTS.CHORES.RECOVERWARMTH.NAME, DUPLICANTS.CHORES.RECOVERWARMTH.STATUS, DUPLICANTS.CHORES.RECOVERWARMTH.TOOLTIP, skip_implicit_priority_change: false);
		RecoverFromHeat = Add("RecoverFromHeat", new string[0], "", new string[0], DUPLICANTS.CHORES.RECOVERFROMHEAT.NAME, DUPLICANTS.CHORES.RECOVERFROMHEAT.STATUS, DUPLICANTS.CHORES.RECOVERFROMHEAT.TOOLTIP, skip_implicit_priority_change: false);
		...
		SleepDueToDisease = Add("SleepDueToDisease", new string[0], "Sleep", new string[3] { "Vomit", "Cough", "EmoteHighPriority" }, DUPLICANTS.CHORES.RESTDUETODISEASE.NAME, DUPLICANTS.CHORES.RESTDUETODISEASE.STATUS, DUPLICANTS.CHORES.RESTDUETODISEASE.TOOLTIP, skip_implicit_priority_change: false);
		...
		RestDueToDisease = Add("RestDueToDisease", new string[0], "RestDueToDisease", new string[3] { "Vomit", "Cough", "EmoteHighPriority" }, DUPLICANTS.CHORES.RESTDUETODISEASE.NAME, DUPLICANTS.CHORES.RESTDUETODISEASE.STATUS, DUPLICANTS.CHORES.RESTDUETODISEASE.TOOLTIP, skip_implicit_priority_change: false);
		...
		Heal = Add("Heal", new string[0], "Heal", new string[3] { "Vomit", "Cough", "EmoteHighPriority" }, DUPLICANTS.CHORES.HEAL.NAME, DUPLICANTS.CHORES.HEAL.STATUS, DUPLICANTS.CHORES.HEAL.TOOLTIP, skip_implicit_priority_change: false);
		...
		Relax = Add("Relax", new string[1] { "Recreation" }, "", new string[1] { "Sleep" }, DUPLICANTS.CHORES.RELAX.NAME, DUPLICANTS.CHORES.RELAX.STATUS, DUPLICANTS.CHORES.RELAX.TOOLTIP, skip_implicit_priority_change: false);
		...
		Attack = Add("Attack", new string[1] { "Combat" }, "", new string[0], DUPLICANTS.CHORES.ATTACK.NAME, DUPLICANTS.CHORES.ATTACK.STATUS, DUPLICANTS.CHORES.ATTACK.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Doctor = Add("DoctorChore", new string[1] { "MedicalAid" }, "Doctor", new string[0], DUPLICANTS.CHORES.DOCTOR.NAME, DUPLICANTS.CHORES.DOCTOR.STATUS, DUPLICANTS.CHORES.DOCTOR.TOOLTIP, skip_implicit_priority_change: false, 5000);
		...
		Art = Add("Art", new string[1] { "Art" }, "", new string[0], DUPLICANTS.CHORES.ART.NAME, DUPLICANTS.CHORES.ART.STATUS, DUPLICANTS.CHORES.ART.TOOLTIP, skip_implicit_priority_change: false, 5000);
		EmptyStorage = Add("EmptyStorage", new string[2] { "Basekeeping", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.EMPTYSTORAGE.NAME, DUPLICANTS.CHORES.EMPTYSTORAGE.STATUS, DUPLICANTS.CHORES.EMPTYSTORAGE.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Mop = Add("Mop", new string[1] { "Basekeeping" }, "", new string[0], DUPLICANTS.CHORES.MOP.NAME, DUPLICANTS.CHORES.MOP.STATUS, DUPLICANTS.CHORES.MOP.TOOLTIP, skip_implicit_priority_change: true, 5000);
		...
		Disinfect = Add("Disinfect", new string[1] { "Basekeeping" }, "", new string[0], DUPLICANTS.CHORES.DISINFECT.NAME, DUPLICANTS.CHORES.DISINFECT.STATUS, DUPLICANTS.CHORES.DISINFECT.TOOLTIP, skip_implicit_priority_change: true, 5000);
		Repair = Add("Repair", new string[1] { "Basekeeping" }, "", new string[0], DUPLICANTS.CHORES.REPAIR.NAME, DUPLICANTS.CHORES.REPAIR.STATUS, DUPLICANTS.CHORES.REPAIR.TOOLTIP, skip_implicit_priority_change: false, 5000);
		RepairFetch = Add("RepairFetch", new string[2] { "Basekeeping", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.REPAIRFETCH.NAME, DUPLICANTS.CHORES.REPAIRFETCH.STATUS, DUPLICANTS.CHORES.REPAIRFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000);
		...
		ExcavateFossil = Add("ExcavateFossil", new string[3] { "Research", "Art", "Dig" }, "", new string[0], DUPLICANTS.CHORES.EXCAVATEFOSSIL.NAME, DUPLICANTS.CHORES.EXCAVATEFOSSIL.STATUS, DUPLICANTS.CHORES.EXCAVATEFOSSIL.TOOLTIP, skip_implicit_priority_change: false, 5000);
		...
		PowerTinker = Add("PowerTinker", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.POWER_TINKER.NAME, DUPLICANTS.CHORES.POWER_TINKER.STATUS, DUPLICANTS.CHORES.POWER_TINKER.TOOLTIP, skip_implicit_priority_change: false, 5000);
		MachineTinker = Add("MachineTinker", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.POWER_TINKER.NAME, DUPLICANTS.CHORES.POWER_TINKER.STATUS, DUPLICANTS.CHORES.POWER_TINKER.TOOLTIP, skip_implicit_priority_change: false, 5000);
		MachineFetch = Add("MachineFetch", new string[2] { "MachineOperating", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.MACHINEFETCH.NAME, DUPLICANTS.CHORES.MACHINEFETCH.STATUS, DUPLICANTS.CHORES.MACHINEFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000, DUPLICANTS.CHORES.MACHINEFETCH.REPORT_NAME);
		Harvest = Add("Harvest", new string[1] { "Farming" }, "", new string[0], DUPLICANTS.CHORES.HARVEST.NAME, DUPLICANTS.CHORES.HARVEST.STATUS, DUPLICANTS.CHORES.HARVEST.TOOLTIP, skip_implicit_priority_change: false, 5000);
		FarmFetch = Add("FarmFetch", new string[2] { "Farming", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.FARMFETCH.NAME, DUPLICANTS.CHORES.FARMFETCH.STATUS, DUPLICANTS.CHORES.FARMFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Uproot = Add("Uproot", new string[1] { "Farming" }, "", new string[0], DUPLICANTS.CHORES.UPROOT.NAME, DUPLICANTS.CHORES.UPROOT.STATUS, DUPLICANTS.CHORES.UPROOT.TOOLTIP, skip_implicit_priority_change: false, 5000);
		CleanToilet = Add("CleanToilet", new string[1] { "Basekeeping" }, "", new string[0], DUPLICANTS.CHORES.CLEANTOILET.NAME, DUPLICANTS.CHORES.CLEANTOILET.STATUS, DUPLICANTS.CHORES.CLEANTOILET.TOOLTIP, skip_implicit_priority_change: false, 5000);
		EmptyDesalinator = Add("EmptyDesalinator", new string[1] { "Basekeeping" }, "", new string[0], DUPLICANTS.CHORES.EMPTYDESALINATOR.NAME, DUPLICANTS.CHORES.EMPTYDESALINATOR.STATUS, DUPLICANTS.CHORES.EMPTYDESALINATOR.TOOLTIP, skip_implicit_priority_change: false, 5000);
		LiquidCooledFan = Add("LiquidCooledFan", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.LIQUIDCOOLEDFAN.NAME, DUPLICANTS.CHORES.LIQUIDCOOLEDFAN.STATUS, DUPLICANTS.CHORES.LIQUIDCOOLEDFAN.TOOLTIP, skip_implicit_priority_change: false, 5000);
		IceCooledFan = Add("IceCooledFan", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.ICECOOLEDFAN.NAME, DUPLICANTS.CHORES.ICECOOLEDFAN.STATUS, DUPLICANTS.CHORES.ICECOOLEDFAN.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Train = Add("Train", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.TRAIN.NAME, DUPLICANTS.CHORES.TRAIN.STATUS, DUPLICANTS.CHORES.TRAIN.TOOLTIP, skip_implicit_priority_change: false, 5000);
		ProcessCritter = Add("ProcessCritter", new string[1] { "Ranching" }, "", new string[0], DUPLICANTS.CHORES.PROCESSCRITTER.NAME, DUPLICANTS.CHORES.PROCESSCRITTER.STATUS, DUPLICANTS.CHORES.PROCESSCRITTER.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Cook = Add("Cook", new string[1] { "Cook" }, "", new string[0], DUPLICANTS.CHORES.COOK.NAME, DUPLICANTS.CHORES.COOK.STATUS, DUPLICANTS.CHORES.COOK.TOOLTIP, skip_implicit_priority_change: false, 5000);
		CookFetch = Add("CookFetch", new string[2] { "Cook", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.COOKFETCH.NAME, DUPLICANTS.CHORES.COOKFETCH.STATUS, DUPLICANTS.CHORES.COOKFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000);
		DoctorFetch = Add("DoctorFetch", new string[2] { "MedicalAid", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.DOCTORFETCH.NAME, DUPLICANTS.CHORES.DOCTORFETCH.STATUS, DUPLICANTS.CHORES.DOCTORFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000, DUPLICANTS.CHORES.DOCTORFETCH.REPORT_NAME);
		Ranch = Add("Ranch", new string[1] { "Ranching" }, "", new string[0], DUPLICANTS.CHORES.RANCH.NAME, DUPLICANTS.CHORES.RANCH.STATUS, DUPLICANTS.CHORES.RANCH.TOOLTIP, skip_implicit_priority_change: false, 5000);
		PowerFetch = Add("PowerFetch", new string[2] { "MachineOperating", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.POWERFETCH.NAME, DUPLICANTS.CHORES.POWERFETCH.STATUS, DUPLICANTS.CHORES.POWERFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000, DUPLICANTS.CHORES.POWERFETCH.REPORT_NAME);
		FlipCompost = Add("FlipCompost", new string[1] { "Farming" }, "", new string[0], DUPLICANTS.CHORES.FLIPCOMPOST.NAME, DUPLICANTS.CHORES.FLIPCOMPOST.STATUS, DUPLICANTS.CHORES.FLIPCOMPOST.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Depressurize = Add("Depressurize", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.DEPRESSURIZE.NAME, DUPLICANTS.CHORES.DEPRESSURIZE.STATUS, DUPLICANTS.CHORES.DEPRESSURIZE.TOOLTIP, skip_implicit_priority_change: false, 5000);
		FarmingFabricate = Add("FarmingFabricate", new string[1] { "Farming" }, "", new string[0], DUPLICANTS.CHORES.FABRICATE.NAME, DUPLICANTS.CHORES.FABRICATE.STATUS, DUPLICANTS.CHORES.FABRICATE.TOOLTIP, skip_implicit_priority_change: false, 5000);
		PowerFabricate = Add("PowerFabricate", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.FABRICATE.NAME, DUPLICANTS.CHORES.FABRICATE.STATUS, DUPLICANTS.CHORES.FABRICATE.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Compound = Add("Compound", new string[1] { "MedicalAid" }, "", new string[0], DUPLICANTS.CHORES.COMPOUND.NAME, DUPLICANTS.CHORES.COMPOUND.STATUS, DUPLICANTS.CHORES.COMPOUND.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Fabricate = Add("Fabricate", new string[1] { "MachineOperating" }, "", new string[0], DUPLICANTS.CHORES.FABRICATE.NAME, DUPLICANTS.CHORES.FABRICATE.STATUS, DUPLICANTS.CHORES.FABRICATE.TOOLTIP, skip_implicit_priority_change: false, 5000);
		FabricateFetch = Add("FabricateFetch", new string[2] { "MachineOperating", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.FABRICATEFETCH.NAME, DUPLICANTS.CHORES.FABRICATEFETCH.STATUS, DUPLICANTS.CHORES.FABRICATEFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000, DUPLICANTS.CHORES.FABRICATEFETCH.REPORT_NAME);
		FoodFetch = Add("FoodFetch", new string[1] { "Hauling" }, "", new string[0], DUPLICANTS.CHORES.FOODFETCH.NAME, DUPLICANTS.CHORES.FOODFETCH.STATUS, DUPLICANTS.CHORES.FOODFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000, DUPLICANTS.CHORES.FOODFETCH.REPORT_NAME);
		Transport = Add("Transport", new string[2] { "Hauling", "Basekeeping" }, "", new string[0], DUPLICANTS.CHORES.TRANSPORT.NAME, DUPLICANTS.CHORES.TRANSPORT.STATUS, DUPLICANTS.CHORES.TRANSPORT.TOOLTIP, skip_implicit_priority_change: true, 5000);
		Build = Add("Build", new string[1] { "Build" }, "", new string[0], DUPLICANTS.CHORES.BUILD.NAME, DUPLICANTS.CHORES.BUILD.STATUS, DUPLICANTS.CHORES.BUILD.TOOLTIP, skip_implicit_priority_change: true, 5000);
		BuildDig = Add("BuildDig", new string[2] { "Build", "Dig" }, "", new string[0], DUPLICANTS.CHORES.BUILDDIG.NAME, DUPLICANTS.CHORES.BUILDDIG.STATUS, DUPLICANTS.CHORES.BUILDDIG.TOOLTIP, skip_implicit_priority_change: true, 5000);
		BuildFetch = Add("BuildFetch", new string[2] { "Build", "Hauling" }, "", new string[0], DUPLICANTS.CHORES.BUILDFETCH.NAME, DUPLICANTS.CHORES.BUILDFETCH.STATUS, DUPLICANTS.CHORES.BUILDFETCH.TOOLTIP, skip_implicit_priority_change: true, 5000);
		Dig = Add("Dig", new string[1] { "Dig" }, "", new string[0], DUPLICANTS.CHORES.DIG.NAME, DUPLICANTS.CHORES.DIG.STATUS, DUPLICANTS.CHORES.DIG.TOOLTIP, skip_implicit_priority_change: false, 5000);
		Fetch = Add("Fetch", new string[1] { "Storage" }, "", new string[0], DUPLICANTS.CHORES.FETCH.NAME, DUPLICANTS.CHORES.FETCH.STATUS, DUPLICANTS.CHORES.FETCH.TOOLTIP, skip_implicit_priority_change: false, 5000, DUPLICANTS.CHORES.FETCH.REPORT_NAME);
		StorageFetch = Add("StorageFetch", new string[1] { "Storage" }, "", new string[0], DUPLICANTS.CHORES.STORAGEFETCH.NAME, DUPLICANTS.CHORES.STORAGEFETCH.STATUS, DUPLICANTS.CHORES.STORAGEFETCH.TOOLTIP, skip_implicit_priority_change: true, 5000, DUPLICANTS.CHORES.STORAGEFETCH.REPORT_NAME);
		EquipmentFetch = Add("EquipmentFetch", new string[1] { "Hauling" }, "", new string[0], DUPLICANTS.CHORES.EQUIPMENTFETCH.NAME, DUPLICANTS.CHORES.EQUIPMENTFETCH.STATUS, DUPLICANTS.CHORES.EQUIPMENTFETCH.TOOLTIP, skip_implicit_priority_change: false, 5000, DUPLICANTS.CHORES.EQUIPMENTFETCH.REPORT_NAME);
		ArmTrap = Add("ArmTrap", new string[1] { "Ranching" }, "", new string[0], DUPLICANTS.CHORES.ARMTRAP.NAME, DUPLICANTS.CHORES.ARMTRAP.STATUS, DUPLICANTS.CHORES.ARMTRAP.TOOLTIP, skip_implicit_priority_change: false);
		...
		ChoreType[][] obj = new ChoreType[33][]
		{
			new ChoreType[1] { Die },
			new ChoreType[1] { Entombed },
			new ChoreType[1] { HealCritical },
			new ChoreType[3] { BeIncapacitated, GeneShuffle, Migrate },
			new ChoreType[1] { DebugGoTo },
			new ChoreType[1] { StressVomit },
			new ChoreType[2] { MoveTo, RocketEnterExit },
			...
			new ChoreType[1] { RocketControl },
			new ChoreType[1] { JoyReaction },
			new ChoreType[1] { Attack },
			new ChoreType[1] { Flee },
			new ChoreType[4] { LearnSkill, UnlearnSkill, Eat, BreakPee },
			new ChoreType[1] { TakeMedicine },
			...
			new ChoreType[69]
			{
				...
				DropUnusedInventory, Harvest, Uproot, FarmingFabricate, PowerFabricate, Compound, Fabricate, Train, ProcessCritter, Cook,
				Build, Dig, BuildDig, FlipCompost, Depressurize, StressEmote, Astronaut, EmptyDesalinator, ArmTrap, FetchCritical,
				ResearchFetch, ExcavateFossil, AnalyzeArtifact, AnalyzeSeed, CreatureFetch, RanchingFetch, Fetch, Transport, FarmFetch, BuildFetch,
				CookFetch, DoctorFetch, MachineFetch, PowerFetch, FabricateFetch, FoodFetch, StorageFetch, RepairFetch, EquipmentFetch
			},
			new ChoreType[2] { RecoverWarmth, RecoverFromHeat },
