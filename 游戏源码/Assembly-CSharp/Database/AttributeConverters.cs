...
public class AttributeConverters : ResourceSet<AttributeConverter>
{
	...
	public AttributeConverters()
	{
		...
		GeotuningSpeed = Create("GeotuningSpeed", "Geotuning Speed", DUPLICANTS.ATTRIBUTES.LEARNING.GEOTUNER_SPEED_MODIFIER, Db.Get().Attributes.Learning, 0.05f, 0f, formatter, DlcManager.AVAILABLE_ALL_VERSIONS);
