...
public class SkillGroups : ResourceSet<SkillGroup>
{
		...
		: base("SkillGroups", parent)
	{
		...
		Mining.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Dig.attribute };
		Mining.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Dig.Id };
		...
		Building.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Build.attribute };
		Building.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Build.Id };
		...
		Farming.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Farming.attribute };
		Farming.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Farming.Id };
		...
		Ranching.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Ranching.attribute };
		Ranching.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Ranching.Id };
		...
		Cooking.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Cook.attribute };
		Cooking.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Cook.Id };
		Art = Add(new SkillGroup("Art", Db.Get().ChoreGroups.Art.Id, DUPLICANTS.CHOREGROUPS.ART.NAME, "icon_errand_art", "icon_archetype_art"));
		Art.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Art.attribute };
		Art.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Art.Id };
		...
		Research.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Research.attribute };
		...
		Suits.relevantAttributes = new List<Attribute> { Db.Get().Attributes.Athletics };
		Suits.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Hauling.Id };
		...
		Hauling.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Hauling.attribute };
		Hauling.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Hauling.Id };
		...
		Technicals.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.MachineOperating.attribute };
		Technicals.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.MachineOperating.Id };
		...
		MedicalAid.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.MedicalAid.attribute };
		...
		Basekeeping.relevantAttributes = new List<Attribute> { Db.Get().ChoreGroups.Basekeeping.attribute };
		Basekeeping.requiredChoreGroups = new List<string> { Db.Get().ChoreGroups.Basekeeping.Id };
	}
}
