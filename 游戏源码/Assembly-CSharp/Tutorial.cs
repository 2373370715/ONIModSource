...
public class Tutorial : KMonoBehaviour, IRender1000ms
{
	...
	public Message TutorialMessage(TutorialMessages tm, bool queueMessage = true)
	{
		...
		case TutorialMessages.TM_Basics:
			message = ((!DistributionPlatform.Initialized || !KInputManager.currentControllerIsGamepad) ? new TutorialMessage(TutorialMessages.TM_Basics, MISC.NOTIFICATIONS.BASICCONTROLS.NAME, MISC.NOTIFICATIONS.BASICCONTROLS.MESSAGEBODY, MISC.NOTIFICATIONS.BASICCONTROLS.TOOLTIP) : new TutorialMessage(TutorialMessages.TM_Basics, MISC.NOTIFICATIONS.BASICCONTROLS.NAME, MISC.NOTIFICATIONS.BASICCONTROLS.MESSAGEBODYALT, MISC.NOTIFICATIONS.BASICCONTROLS.TOOLTIP));
			break;
