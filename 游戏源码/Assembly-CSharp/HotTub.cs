...
public class HotTub : StateMachineComponent<HotTub.StatesInstance>, IGameObjectEffectDescriptor
{
	...
	protected override void OnSpawn()
	{
		...
		for (int i = 0; i < workables.Length; i++)
		{
			...
			int player_index = i;
			hotTubWorkable.OnWorkableEventCB = (Action<Workable, Workable.WorkableEvent>)Delegate.Combine(hotTubWorkable.OnWorkableEventCB, (Action<Workable, Workable.WorkableEvent>)delegate(Workable workable, Workable.WorkableEvent ev)
			{
