...
public class OxygenMaskLockerConfig : IBuildingConfig
{
	...
	public override BuildingDef CreateBuildingDef()
	{
		...
		BuildingDef obj = BuildingTemplates.CreateBuildingDef(construction_mass: BUILDINGS.CONSTRUCTION_MASS_KG.TIER2, construction_materials: rAW_METALS, melting_point: 1600f, build_location_rule: BuildLocationRule.OnFloor, noise: NOISE_POLLUTION.NONE, id: "OxygenMaskLocker", width: 1, height: 2, anim: "oxygen_mask_locker_kanim", hitpoints: 30, construction_time: 30f, decor: BUILDINGS.DECOR.BONUS.TIER1);
