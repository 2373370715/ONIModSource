...
public class CodexScreen : KScreen
{
	...
	private void SetupPrefabs()
	{
		...
		ContentPrefabs[typeof(CodexConfigurableConsumerRecipePanel)] = PrefabConfigurableConsumerRecipePanel;
		ContentPrefabs[typeof(CodexTemperatureTransitionPanel)] = PrefabTemperatureTransitionPanel;
		ContentPrefabs[typeof(CodexConversionPanel)] = prefabConversionPanel;
		ContentPrefabs[typeof(CodexCollapsibleHeader)] = prefabCollapsibleHeader;
		ContentPrefabs[typeof(CodexCritterLifecycleWidget)] = prefabCritterLifecycleWidget;
	}
	...
	private void CategorizeEntries()
	{
		...
		SetupCategory(dictionary, "CREATURES::GeneralInfo");
