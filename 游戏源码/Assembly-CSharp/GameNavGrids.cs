...
public class GameNavGrids
{
	...
	public GameNavGrids(Pathfinding pathfinding)
	{
		...
		WalkerGrid2x2 = CreateWalkerLargeNavigation(pathfinding, "WalkerNavGrid2x2", new CellOffset[2]
		{
			new CellOffset(0, 0),
			new CellOffset(0, 1)
		});
	...
	{
		NavGrid.Transition[] transitions = new NavGrid.Transition[3]
		{
			new NavGrid.Transition(NavType.Floor, NavType.Floor, 1, 0, NavAxis.NA, is_looping: true, loop_has_pre: true, is_escape: true, 1, "", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], critter: true),
			new NavGrid.Transition(NavType.Floor, NavType.Floor, 1, 1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: true, 1, "", new CellOffset[1]
			{
			...
			}, new CellOffset[2]
			{
				new CellOffset(1, 0),
				new CellOffset(2, 0)
			}, new NavOffset[0], new NavOffset[0], critter: true),
			new NavGrid.Transition(NavType.Floor, NavType.Floor, 1, -1, NavAxis.NA, is_looping: false, loop_has_pre: false, is_escape: true, 1, "", new CellOffset[3]
			{
				new CellOffset(1, 0),
				new CellOffset(2, 0),
				new CellOffset(2, -1)
