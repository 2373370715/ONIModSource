...
public class LaunchableRocketCluster : StateMachineComponent<LaunchableRocketCluster.StatesInstance>, ILaunchableRocket
{
	public class StatesInstance : GameStateMachine<States, StatesInstance, LaunchableRocketCluster, object>.GameInstance
	{
		...
		public void SetupLaunch()
		{
			...
			if (craftInterface != null)
			{
				...
				{
					minionMigrationEventArgs.minionId = item;
		...
		public void SetupLanding()
		{
			...
			DistanceAboveGround = distanceAboveGround;
	...
	public class States : GameStateMachine<States, StatesInstance, LaunchableRocketCluster>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			{
				smi.SetupLaunch();
				distanceToSpace.Set(ConditionFlightPathIsClear.PadTopEdgeDistanceToOutOfScreenEdge(smi.master.gameObject.GetComponent<RocketModuleCluster>().CraftInterface.CurrentPad.gameObject), smi);
			...
			}).Update(delegate(StatesInstance smi, float dt)
			{
				...
				.ParamTransition(distanceAboveGround, not_grounded.launch_pst, (StatesInstance smi, float p) => p >= distanceToSpace.Get(smi))
			...
			not_grounded.launch_pst.ScheduleGoTo(0f, not_grounded.space);
