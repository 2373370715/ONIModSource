...
public class CrabWoodConfig : IEntityConfig
{
	...
	{
		GameObject prefab = EntityTemplates.ExtendEntityToWildCreature(BaseCrabConfig.BaseCrab(id, name, desc, anim_file, "CrabWoodBaseTrait", is_baby, animPrefix, deathDropID, 5), CrabTuning.PEN_SIZE_PER_CREATURE);
	...
	public GameObject CreatePrefab()
	{
		...
		prefab = EntityTemplates.ExtendEntityToFertileCreature(prefab, "CrabWoodEgg", STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.EGG_NAME, STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.DESC, "egg_pincher_kanim", CrabTuning.EGG_MASS, "CrabWoodBaby", 60.000004f, 20f, CrabTuning.EGG_CHANCES_WOOD, GetDlcIds(), EGG_SORT_ORDER);
