...
public class PropFacilityChandelierConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreatePlacedEntity("PropFacilityChandelier", STRINGS.BUILDINGS.PREFABS.PROPFACILITYCHANDELIER.NAME, STRINGS.BUILDINGS.PREFABS.PROPFACILITYCHANDELIER.DESC, 50f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_chandelier_kanim"), initialAnim: "off", sceneLayer: Grid.SceneLayer.Building, width: 5, height: 7, permittedRotation: PermittedRotations.R90, orientation: Orientation.Neutral, element: SimHashes.Creature, additionalTags: new List<Tag> { GameTags.Gravitas });
