...
public class BasicSingleHarvestPlantConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		}, pressure_sensitive: true, 0f, 0.15f, "BasicPlantFood", can_drown: true, can_tinker: false, require_solid_tile: true, should_grow_old: true, 2400f, 0f, 4600f, "BasicSingleHarvestPlantOriginal", STRINGS.CREATURES.SPECIES.BASICSINGLEHARVESTPLANT.NAME);
