...
public class ArcadeMachine : StateMachineComponent<ArcadeMachine.StatesInstance>, IGameObjectEffectDescriptor
{
	...
	protected override void OnSpawn()
	{
		...
		for (int i = 0; i < workables.Length; i++)
		{
			...
			int player_index = i;
			arcadeMachineWorkable.OnWorkableEventCB = (Action<Workable, Workable.WorkableEvent>)Delegate.Combine(arcadeMachineWorkable.OnWorkableEventCB, (Action<Workable, Workable.WorkableEvent>)delegate(Workable workable, Workable.WorkableEvent ev)
			{
