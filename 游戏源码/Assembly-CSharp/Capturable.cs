...
public class Capturable : Workable, IGameObjectEffectDescriptor
{
	...
	public void MarkForCapture(bool mark, PrioritySetting priority, bool updateMarkedPriority = false)
	{
		...
		else if (updateMarkedPriority && markedForCapture && mark)
		{
	...
	private void UpdateChore()
	{
		...
		{
			chore = new WorkChore<Capturable>(Db.Get().ChoreTypes.Capture, this, null, run_until_complete: true, null, OnChoreBegins, OnChoreEnds, allow_in_red_alert: true, null, ignore_schedule_block: false, only_when_operational: true, null, is_preemptable: true);
		}
