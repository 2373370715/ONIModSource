...
public class Rotatable : KMonoBehaviour, ISaveLoadable
{
	...
	protected override void OnSpawn()
	{
		...
		if (component != null)
		{
			SetSize(component.Def.WidthInCells, component.Def.HeightInCells);
		}
	...
	public Vector2I GetRotatedOffset(Vector2I offset)
	{
		return orientation switch
		{
			Orientation.R90 => new Vector2I(offset.y, -offset.x), 
			Orientation.R180 => new Vector2I(-offset.x, -offset.y), 
			Orientation.R270 => new Vector2I(-offset.y, offset.x), 
			Orientation.FlipH => new Vector2I(-offset.x, offset.y), 
			Orientation.FlipV => new Vector2I(offset.x, -offset.y), 
			_ => offset, 
		};
	}
