public class FetchableMonitor : GameStateMachine<FetchableMonitor, FetchableMonitor.Instance>
{
	public new class Instance : GameInstance
	{
		...
		{
			Game.Instance.fetchManager.Remove(base.smi.pickupable.KPrefabID.PrefabID(), fetchable);
		...
		public bool IsFetchable()
		{
			...
			if (pickupable.KPrefabID.HasTag(GameTags.Creature) && !pickupable.KPrefabID.HasTag(GameTags.Creatures.Deliverable))
			{
				return false;
			}
			return true;
