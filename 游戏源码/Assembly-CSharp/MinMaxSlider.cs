...
public class MinMaxSlider : KMonoBehaviour
{
	...
	protected override void OnSpawn()
	{
		...
		Slider.Direction direction2 = (maxSlider.direction = this.direction);
		slider.direction = direction2;
		...
		if (extraSlider != null)
		{
			...
			Slider slider3 = minSlider;
			bool flag2 = (maxSlider.wholeNumbers = wholeNumbers);
			bool flag4 = (slider3.wholeNumbers = flag2);
			slider2.wholeNumbers = flag4;
	...
	{
		float num2 = (minSlider.value = currentMin);
		currentMinValue = num2;
		num2 = (maxSlider.value = currentMax);
		currentMaxValue = num2;
		minLimit = min;
		maxLimit = max;
		minSlider.minValue = minLimit;
		maxSlider.minValue = minLimit;
