	...
	protected override void OnCompleteWork(Worker worker)
	{
		...
		if (IsReplacementTile)
		{
			...
			if (replacementCandidate != null)
			{
				...
				ReplaceCallbackParameters replaceCallbackParameters = default(ReplaceCallbackParameters);
				replaceCallbackParameters.TileLayer = building.Def.TileLayer;
				replaceCallbackParameters.Worker = worker;
				ReplaceCallbackParameters replaceCallbackParameters2 = replaceCallbackParameters;
				replacementCandidate.Trigger(1606648047, replaceCallbackParameters2);
