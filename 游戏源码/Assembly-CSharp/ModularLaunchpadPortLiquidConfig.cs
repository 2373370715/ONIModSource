...
public class ModularLaunchpadPortLiquidConfig : IBuildingConfig
{
	...
	{
		return BaseModularLaunchpadPortConfig.CreateBaseLaunchpadPort("ModularLaunchpadPortLiquid", "conduit_port_liquid_loader_kanim", ConduitType.Liquid, isLoader: true, 2, 2);
	}
