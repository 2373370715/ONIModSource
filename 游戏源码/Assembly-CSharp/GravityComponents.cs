...
{
	// Token: 0x06006738 RID: 26424 RVA: 0x002D3BD4 File Offset: 0x002D1DD4
	...
	// Token: 0x06006739 RID: 26425 RVA: 0x002D3C24 File Offset: 0x002D1E24
			...
			if (gravityComponent.elapsedTime >= 0f && !(gravityComponent.transform == null) && !base.IsInCleanupList(gravityComponent.transform.gameObject))
			{
				...
				if (Grid.IsValidCell(num6))
				{
					...
					if (flag4)
					{
						...
						vector3.y = vector4.y + groundOffset;
