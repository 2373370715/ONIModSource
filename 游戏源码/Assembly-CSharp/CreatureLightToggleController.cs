...
public class CreatureLightToggleController : GameStateMachine<CreatureLightToggleController, CreatureLightToggleController.Instance, IStateMachineTarget, CreatureLightToggleController.Def>
{
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		}).EventHandlerTransition(GameHashes.TagsChanged, turning_on, ShouldProduceLight);
		...
		}).EventHandlerTransition(GameHashes.TagsChanged, turning_off, (Instance smi, object obj) => !ShouldProduceLight(smi, obj));
	...
	public static bool ShouldProduceLight(Instance smi, object obj)
	{
		if (smi.prefabID.HasTag(GameTags.Creatures.Overcrowded))
		{
			return false;
		}
		if (smi.prefabID.HasTag(GameTags.Creatures.TrappedInCargoBay))
		{
			return false;
		}
		return true;
