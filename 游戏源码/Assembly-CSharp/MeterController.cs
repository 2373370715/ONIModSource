...
public class MeterController
{
	...
	public Func<float, int, float> interpolateFunction = MinMaxStepLerp;
	...
	public void SetPositionPercent(float percent_full)
	{
		...
		{
			meterController.SetPositionPercent(interpolateFunction(percent_full, meterController.GetCurrentNumFrames()));
		}
	}
