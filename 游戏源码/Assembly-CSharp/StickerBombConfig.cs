...
public class StickerBombConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreateBasicEntity("StickerBomb", STRINGS.BUILDINGS.PREFABS.STICKERBOMB.NAME, STRINGS.BUILDINGS.PREFABS.STICKERBOMB.DESC, 1f, unitMass: true, Assets.GetAnim("sticker_a_kanim"), "off", Grid.SceneLayer.Backwall);
