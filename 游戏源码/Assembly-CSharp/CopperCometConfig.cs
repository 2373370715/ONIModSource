...
public class CopperCometConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreateEntity(ID, UI.SPACEDESTINATIONS.COMETS.COPPERCOMET.NAME);
		...
		kBatchedAnimController.AnimFiles = new KAnimFile[1] { Assets.GetAnim("meteor_copper_kanim") };
