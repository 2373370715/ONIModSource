public class RocketCommandConditions : KMonoBehaviour
{
	...
	protected override void OnSpawn()
	{
		...
		else if (GetComponent<ILaunchableRocket>().registerType == LaunchableRocketRegisterType.Clustercraft)
		{
			...
			HasCargoBayForNoseconeHarvest = (ConditionHasCargoBayForNoseconeHarvest)component.AddModuleCondition(ProcessCondition.ProcessConditionType.RocketStorage, new ConditionHasCargoBayForNoseconeHarvest(GetComponent<LaunchableRocketCluster>()));
		}
		int bufferWidth = 1;
