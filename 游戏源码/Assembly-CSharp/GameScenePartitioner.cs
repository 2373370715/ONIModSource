...
public class GameScenePartitioner : KMonoBehaviour
{
	...
	protected override void OnPrefabInit()
	{
		Debug.Assert(instance == null);
		instance = this;
		partitioner = new ScenePartitioner(16, 66, Grid.WidthInCells, Grid.HeightInCells);
	...
	{
		UnsafeReadonlyGatherEntries(extents.x, extents.y, extents.width, extents.height, layer, gathered_entries);
	}
	...
	{
		partitioner.UnsafeReadonlyGatherEntries(x_bottomLeft, y_bottomLeft, width, height, layer, gathered_entries);
	}
