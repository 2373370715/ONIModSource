...
public class PropFacilityDeskConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreatePlacedEntity("PropFacilityDesk", STRINGS.BUILDINGS.PREFABS.PROPFACILITYDESK.NAME, STRINGS.BUILDINGS.PREFABS.PROPFACILITYDESK.DESC, 50f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_desk_kanim"), initialAnim: "off", sceneLayer: Grid.SceneLayer.Building, width: 4, height: 2, permittedRotation: PermittedRotations.R90, orientation: Orientation.Neutral, element: SimHashes.Creature, additionalTags: new List<Tag> { GameTags.Gravitas });
