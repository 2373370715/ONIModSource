...
public class CodexRecipePanel : CodexWidget<CodexRecipePanel>
{
	...
	public CodexRecipePanel(ComplexRecipe recipe, bool shouldUseFabricatorForTitle = false)
	{
		...
		useFabricatorForTitle = shouldUseFabricatorForTitle;
	}
	...
	public override void Configure(GameObject contentGameObject, Transform displayPane, Dictionary<CodexTextStyle, TextStyleSetting> textStyles)
	{
		...
		else if (complexRecipe != null && SaveLoader.Instance.IsDlcListActiveForCurrentSave(complexRecipe.GetDlcIds()))
		{
	...
	private void ConfigureComplexRecipe()
	{
		...
		if (useFabricatorForTitle)
		{
			title.text = fabricator.GetProperName();
		}
		else
		{
