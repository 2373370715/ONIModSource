...
public class NuclearResearchCenter : StateMachineComponent<NuclearResearchCenter.StatesInstance>, IResearchCenter, IGameObjectEffectDescriptor
{
	public class States : GameStateMachine<States, StatesInstance, NuclearResearchCenter>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			requirements.noResearchSelected.Enter(delegate(StatesInstance smi)
			{
				UpdateNoResearchSelectedStatusItem(smi, entering: true);
			}).Exit(delegate(StatesInstance smi)
			{
				UpdateNoResearchSelectedStatusItem(smi, entering: false);
			}).EventTransition(GameHashes.ActiveResearchChanged, requirements.noApplicableResearch, IsResearchSelected);
		...
		private void UpdateNoResearchSelectedStatusItem(StatesInstance smi, bool entering)
		{
			bool num = entering && !IsResearchSelected(smi) && !IsAllResearchComplete();
