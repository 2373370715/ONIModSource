...
public class DiamondPressConfig : IBuildingConfig
{
	...
	public override void DoPostConfigureComplete(GameObject go)
	{
		...
		go.GetComponent<KPrefabID>().prefabSpawnFn += delegate(GameObject game_object)
		{
			...
			MeterController meter = new MeterController(component.GetAnimController(), "meter_target", "meter", Meter.Offset.Infront, Grid.SceneLayer.NoLayer, "meter_target", "meter_fill", "meter_frame", "meter_OL");
