...
public class WoodGasGeneratorConfig : IBuildingConfig
{
	...
	public override void DoPostConfigureComplete(GameObject go)
	{
		...
		energyGenerator.formula = EnergyGenerator.CreateSimpleFormula(SimHashes.WoodLog.CreateTag(), 1.2f, max_stored_input_mass, SimHashes.CarbonDioxide, 0.17f, store_output_mass: false, new CellOffset(0, 1), 383.15f);
