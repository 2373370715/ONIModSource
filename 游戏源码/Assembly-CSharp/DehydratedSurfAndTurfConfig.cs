...
public class DehydratedSurfAndTurfConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		GameObject gameObject = EntityTemplates.CreateLooseEntity(ID.Name, ITEMS.FOOD.SURFANDTURF.DEHYDRATED.NAME, ITEMS.FOOD.SURFANDTURF.DEHYDRATED.DESC, 1f, unitMass: true, anim, "idle", Grid.SceneLayer.BuildingFront, EntityTemplates.CollisionShape.RECTANGLE, 0.6f, 0.7f, isPickupable: true, 0, SimHashes.Polypropylene);
