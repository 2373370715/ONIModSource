...
public class CarrotConfig : IEntityConfig
{
	...
	{
		return EntityTemplates.ExtendEntityToFood(EntityTemplates.CreateLooseEntity(ID, ITEMS.FOOD.CARROT.NAME, ITEMS.FOOD.CARROT.DESC, 1f, unitMass: false, Assets.GetAnim("purplerootVegetable_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.RECTANGLE, 0.8f, 0.4f, isPickupable: true), FOOD.FOOD_TYPES.CARROT);
	}
