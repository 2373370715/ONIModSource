...
public class Desalinator : StateMachineComponent<Desalinator.StatesInstance>
{
	...
	public class States : GameStateMachine<States, StatesInstance, Desalinator>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			}).QueueAnim("working_loop", loop: true).EventTransition(GameHashes.OnStorageChange, on.working_pst, (StatesInstance smi) => !smi.master.CheckCanConvert())
				.ParamTransition(saltStorageLeft, full, (StatesInstance smi, float p) => smi.IsFull())
