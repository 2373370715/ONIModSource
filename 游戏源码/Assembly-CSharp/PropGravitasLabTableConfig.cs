...
public class PropGravitasLabTableConfig : IEntityConfig
{
	...
	{
		GameObject obj = EntityTemplates.CreatePlacedEntity("PropGravitasLabTable", STRINGS.BUILDINGS.PREFABS.PROPGRAVITASLABTABLE.NAME, STRINGS.BUILDINGS.PREFABS.PROPGRAVITASLABTABLE.DESC, 50f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_lab_table_kanim"), initialAnim: "off", sceneLayer: Grid.SceneLayer.Building, width: 3, height: 2, element: SimHashes.Creature, additionalTags: new List<Tag> { GameTags.Gravitas });
