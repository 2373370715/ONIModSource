...
public class FOOD
{
	...
	public class FOOD_TYPES
	{
		...
		public static readonly EdiblesManager.FoodInfo ICECAVESFORAGEPLANT = new EdiblesManager.FoodInfo("IceCavesForagePlant", "DLC2_ID", 800000f, -1, 255.15f, 277.15f, 4800f, can_rot: false);
		...
		public static readonly EdiblesManager.FoodInfo SHELLFISH_MEAT = new EdiblesManager.FoodInfo("ShellfishMeat", "", 1000000f, 2, 255.15f, 277.15f, 2400f, can_rot: true).AddEffects(new List<string> { "SeafoodRadiationResistance" }, DlcManager.AVAILABLE_EXPANSION1_ONLY);
		...
		public static readonly EdiblesManager.FoodInfo HARDSKINBERRY = new EdiblesManager.FoodInfo("HardSkinBerry", "DLC2_ID", 800000f, -1, 255.15f, 277.15f, 9600f, can_rot: true);

		public static readonly EdiblesManager.FoodInfo CARROT = new EdiblesManager.FoodInfo(CarrotConfig.ID, "DLC2_ID", 4000000f, 0, 255.15f, 277.15f, 9600f, can_rot: true);

		public static readonly EdiblesManager.FoodInfo PEMMICAN = new EdiblesManager.FoodInfo("Pemmican", "DLC2_ID", HARDSKINBERRY.CaloriesPerUnit * 2f + 1000000f, 2, 255.15f, 277.15f, 19200f, can_rot: false);

		public static readonly EdiblesManager.FoodInfo FRIES_CARROT = new EdiblesManager.FoodInfo("FriesCarrot", "DLC2_ID", 5400000f, 3, 255.15f, 277.15f, 2400f, can_rot: true);

		public static readonly EdiblesManager.FoodInfo DEEP_FRIED_MEAT = new EdiblesManager.FoodInfo("DeepFriedMeat", "DLC2_ID", 4000000f, 3, 255.15f, 277.15f, 2400f, can_rot: true);

		public static readonly EdiblesManager.FoodInfo DEEP_FRIED_NOSH = new EdiblesManager.FoodInfo("DeepFriedNosh", "DLC2_ID", 5000000f, 3, 255.15f, 277.15f, 4800f, can_rot: true);

		public static readonly EdiblesManager.FoodInfo DEEP_FRIED_FISH = new EdiblesManager.FoodInfo("DeepFriedFish", "DLC2_ID", 4200000f, 4, 255.15f, 277.15f, 2400f, can_rot: true).AddEffects(new List<string> { "SeafoodRadiationResistance" }, DlcManager.AVAILABLE_EXPANSION1_ONLY);

		public static readonly EdiblesManager.FoodInfo DEEP_FRIED_SHELLFISH = new EdiblesManager.FoodInfo("DeepFriedShellfish", "DLC2_ID", 4200000f, 4, 255.15f, 277.15f, 2400f, can_rot: true).AddEffects(new List<string> { "SeafoodRadiationResistance" }, DlcManager.AVAILABLE_EXPANSION1_ONLY);
		...
		public static readonly EdiblesManager.FoodInfo COOKED_PIKEAPPLE = new EdiblesManager.FoodInfo("CookedPikeapple", "DLC2_ID", 1200000f, 1, 255.15f, 277.15f, 4800f, can_rot: true);
		...
		public static readonly EdiblesManager.FoodInfo CURRY = new EdiblesManager.FoodInfo("Curry", "", 5000000f, 4, 255.15f, 277.15f, 9600f, can_rot: true).AddEffects(new List<string> { "HotStuff", "WarmTouchFood" }, DlcManager.AVAILABLE_ALL_VERSIONS);
		...
		public static readonly EdiblesManager.FoodInfo SPICY_TOFU = new EdiblesManager.FoodInfo("SpicyTofu", "", 4000000f, 5, 255.15f, 277.15f, 2400f, can_rot: true).AddEffects(new List<string> { "WarmTouchFood" }, DlcManager.AVAILABLE_ALL_VERSIONS);

		public static readonly EdiblesManager.FoodInfo QUICHE = new EdiblesManager.FoodInfo("Quiche", "", 6400000f, 5, 255.15f, 277.15f, 2400f, can_rot: true).AddEffects(new List<string> { "SeafoodRadiationResistance" }, DlcManager.AVAILABLE_EXPANSION1_ONLY);
