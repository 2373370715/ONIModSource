...
public struct Extents
{
	...
	public static BoundExtendsToGridFlag BoundsCheckCoords;
	...
	public Extents(int cell, CellOffset[] offsets, BoundExtendsToGridFlag _)
	{
		int num = 0;
		int num2 = 0;
		Grid.CellToXY(cell, out num, out num2);
	...
	{
		if ((float)x <= pos.x && pos.x < (float)(x + width) && (float)y <= pos.y)
		{
			return pos.y < (float)(y + height);
		}
		return false;
	}
}
