...
public class EggCracker : KMonoBehaviour
{
	...
	protected override void OnSpawn()
	{
		...
		complexFabricatorWorkable.OnWorkableEventCB = (Action<Workable, Workable.WorkableEvent>)Delegate.Combine(complexFabricatorWorkable.OnWorkableEventCB, new Action<Workable, Workable.WorkableEvent>(OnWorkableEvent));
	}
