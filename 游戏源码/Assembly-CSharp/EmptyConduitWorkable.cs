...
public class EmptyConduitWorkable : Workable, IEmptyConduitWorkable
{
	...
	protected override void OnPrefabInit()
	{
		...
		{
			emptyLiquidConduitStatusItem = new StatusItem("EmptyLiquidConduit", BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.NAME, BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.TOOLTIP, "status_item_empty_pipe", StatusItem.IconType.Custom, NotificationType.Neutral, allow_multiples: false, OverlayModes.LiquidConduits.ID, 66);
			emptyGasConduitStatusItem = new StatusItem("EmptyGasConduit", BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.NAME, BUILDINGS.PREFABS.CONDUIT.STATUS_ITEM.TOOLTIP, "status_item_empty_pipe", StatusItem.IconType.Custom, NotificationType.Neutral, allow_multiples: false, OverlayModes.GasConduits.ID, 130);
		}
	...
	public void EmptyContents()
	{
		...
		if (conduitContents.mass > 0f && conduitContents.element != SimHashes.Vacuum)
		{
			(conduit.type switch
			{
				...
				_ => throw new ArgumentException(), 
			}).CreateChunk(conduitContents.element, conduitContents.mass, conduitContents.temperature, conduitContents.diseaseIdx, conduitContents.diseaseCount, Grid.CellToPosCCC(cell, Grid.SceneLayer.Ore)).Trigger(580035959, base.worker);
		}
	}
