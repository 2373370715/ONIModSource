	...
	private void UpdateFrame()
	{
		...
		if (controller.CurrentAnim != null)
		{
			...
			if (symbolVisible && (previousMatrix != symbolLocalTransform || position != previousPosition || (useTargetPoint && targetPoint != previousTargetPoint) || (matchParentOffset && myAnim.Offset != controller.Offset)))
			{
				...
				Matrix2x3 overrideTransformMatrix = ((useTargetPoint || myAnim == null) ? controller.GetTransformMatrix() : controller.GetTransformMatrix(new Vector2(myAnim.animWidth * myAnim.animScale, (0f - myAnim.animHeight) * myAnim.animScale))) * symbolLocalTransform;
