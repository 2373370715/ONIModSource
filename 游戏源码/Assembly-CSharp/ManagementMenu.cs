...
public class ManagementMenu : KIconToggleMenu
{
	...
	protected override void OnPrefabInit()
	{
		...
		researchInfo.prefabOverride = researchButtonPrefab;
	...
	public void OpenCodexToLockId(string lockId, bool focusContent = false)
	{
		...
		{
			DebugUtil.LogWarningArgs("Could not open codex to lockId \"" + lockId + "\", couldn't find an entry that contained that lockId");
			return;
		}
		...
		OpenCodexToEntry(entryForLock, contentContainer);
	}
	...
	public void OpenCodexToEntry(string id, ContentContainer targetContainer = null)
	{
		...
		codexScreen.FocusContainer(targetContainer);
	}
