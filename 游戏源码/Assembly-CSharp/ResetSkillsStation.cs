...
public class ResetSkillsStation : Workable
{
	...
	protected override void OnStartWork(Worker worker)
	{
		...
		GetComponent<KSelectable>().AddStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorTraining, this);
	}
	...
	protected override void OnStopWork(Worker worker)
	{
		...
		GetComponent<KSelectable>().RemoveStatusItem(Db.Get().BuildingStatusItems.ComplexFabricatorTraining, this);
		chore = null;
	}
}
