...
public class CookedPikeappleConfig : IEntityConfig
{
	...
	{
		return EntityTemplates.ExtendEntityToFood(EntityTemplates.CreateLooseEntity("CookedPikeapple", ITEMS.FOOD.COOKEDPIKEAPPLE.NAME, ITEMS.FOOD.COOKEDPIKEAPPLE.DESC, 1f, unitMass: false, Assets.GetAnim("iceberry_cooked_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.RECTANGLE, 0.8f, 0.6f, isPickupable: true), FOOD.FOOD_TYPES.COOKED_PIKEAPPLE);
	}
