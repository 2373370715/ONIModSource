...
public class PropFacilityChairConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreatePlacedEntity("PropFacilityChair", STRINGS.BUILDINGS.PREFABS.PROPFACILITYCHAIR.NAME, STRINGS.BUILDINGS.PREFABS.PROPFACILITYCHAIR.DESC, 50f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_chair_kanim"), initialAnim: "off", sceneLayer: Grid.SceneLayer.Building, width: 2, height: 2, permittedRotation: PermittedRotations.R90, orientation: Orientation.Neutral, element: SimHashes.Creature, additionalTags: new List<Tag> { GameTags.Gravitas });
