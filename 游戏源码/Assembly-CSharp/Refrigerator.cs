...
public class Refrigerator : KMonoBehaviour, IUserControlledCapacity
{
	...
	{
		filteredStorage = new FilteredStorage(this, new Tag[1] { GameTags.Compostable }, this, use_logic_meter: true, Db.Get().ChoreTypes.FoodFetch);
	}

	protected override void OnSpawn()
	{
		GetComponent<KAnimControllerBase>().Play("off");
		FoodStorage component = GetComponent<FoodStorage>();
