...
public struct InfraredVisualizerData
{
	...
	public void Update()
	{
		...
		else if (critterTemperatureMonitorInstance != null)
		{
			num = critterTemperatureMonitorInstance.GetTemperatureInternal();
		}
		if (!(num < 0f))
		{
	...
	public InfraredVisualizerData(GameObject go)
	{
		...
		if (controller != null)
		{
			...
			critterTemperatureMonitorInstance = go.GetSMI<CritterTemperatureMonitor.Instance>();
		}
		else
		{
