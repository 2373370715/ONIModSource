...
public class BaggedStates : GameStateMachine<BaggedStates, BaggedStates.Instance, IStateMachineTarget, BaggedStates.Def>
{
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		bagged.Enter(BagStart).ToggleTag(GameTags.Creatures.Deliverable).PlayAnim(GetBaggedAnimName, KAnim.PlayMode.Loop)
	...
	public static string GetBaggedAnimName(Instance smi)
	{
