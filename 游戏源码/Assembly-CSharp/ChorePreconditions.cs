...
public class ChorePreconditions
{
	...
	public Chore.Precondition IsInMyRoom = new Chore.Precondition
	{
		...
		{
			int cell3 = (int)data;
			CavityInfo cavityForCell = Game.Instance.roomProber.GetCavityForCell(cell3);
			Room room = null;
	...
	public Chore.Precondition IsChattable = new Chore.Precondition
	{
		...
		fn = delegate(ref Chore.Precondition.Context context, object data)
		{
			...
			return !(kMonoBehaviour2 == null) && context.consumerState.navigator.CanReach(Grid.PosToCell(kMonoBehaviour2));
		}
	};
	...
	public Chore.Precondition CanMoveTo = new Chore.Precondition
	{
		...
		fn = delegate(ref Chore.Precondition.Context context, object data)
		{
			...
			if (context.consumerState.consumer.GetNavigationCost(approachable, out var cost3))
			{
				context.cost += cost3;
				return true;
			}
	...
	public Chore.Precondition CanMoveToCell = new Chore.Precondition
	{
		...
		fn = delegate(ref Chore.Precondition.Context context, object data)
		{
			...
			if (context.consumerState.consumer.GetNavigationCost(cell2, out var cost2))
			{
				context.cost += cost2;
				return true;
			}
