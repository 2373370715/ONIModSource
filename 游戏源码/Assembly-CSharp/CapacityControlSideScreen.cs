...
public class CapacityControlSideScreen : SideScreenContent
{
	...
	{
		if (target.GetComponent<IUserControlledCapacity>().IsNullOrDestroyed())
		{
			return target.GetSMI<IUserControlledCapacity>() != null;
		}
		return true;
	}
	...
	public override void SetTarget(GameObject new_target)
	{
		...
		if (target == null)
		{
			target = new_target.GetSMI<IUserControlledCapacity>();
		}
		if (target == null)
		{
