...
public class AnimEventManager : Singleton<AnimEventManager>
{
	...
	public readonly struct DevTools_DebugInfo
	{
		...
		public DevTools_DebugInfo(AnimEventManager eventManager, KCompactedVector<AnimData> animData, KCompactedVector<EventPlayerData> eventData, KCompactedVector<AnimData> uiAnimData, KCompactedVector<EventPlayerData> uiEventData)
		{
