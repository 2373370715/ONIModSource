...
public class VerticalWindTunnel : StateMachineComponent<VerticalWindTunnel.StatesInstance>, IGameObjectEffectDescriptor, ISim200ms
{
	...
	protected override void OnSpawn()
	{
		...
		for (int i = 0; i < workables.Length; i++)
		{
			...
			int player_index = i;
			verticalWindTunnelWorkable.OnWorkableEventCB = (Action<Workable, Workable.WorkableEvent>)Delegate.Combine(verticalWindTunnelWorkable.OnWorkableEventCB, (Action<Workable, Workable.WorkableEvent>)delegate(Workable workable, Workable.WorkableEvent ev)
			{
