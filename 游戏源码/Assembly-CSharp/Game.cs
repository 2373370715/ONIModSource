...
public class Game : KMonoBehaviour
{
	...
	protected override void OnPrefabInit()
	{
		...
		changelistsPlayedOn.Add(623711u);
	...
	{
		if (previewVisualizer == entity_cell_visualizer)
		{
	...
	private void UpdateOverlayScreen()
	{
		...
		foreach (EntityCellVisualizer item in Components.EntityCellVisualizers.Items)
		{
			item.DrawIcons(mode);
		}
	...
	private void InitializeFXSpawners()
	{
		for (int i = 0; i < fxSpawnData.Length; i++)
		{
			...
			GameObjectPool pool = new GameObjectPool(instantiator, fxSpawnData[fx_idx].initialCount);
	...
	public void Save(BinaryWriter writer)
	{
		...
		if (!changelistsPlayedOn.Contains(623711u))
		{
			changelistsPlayedOn.Add(623711u);
		}
