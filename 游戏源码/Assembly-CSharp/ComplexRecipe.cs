...
public class ComplexRecipe
{
	...
	public ComplexRecipe(string id, RecipeElement[] ingredients, RecipeElement[] results, string[] dlcIds)
		: this(id, ingredients, results)
	{
		this.dlcIds = dlcIds;
	}

	public ComplexRecipe(string id, RecipeElement[] ingredients, RecipeElement[] results, int consumedHEP, int producedHEP, string[] dlcIds)
