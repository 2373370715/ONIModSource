...
public class PortalUtilityNetworkLinkContainer {
    ...
    public PortalUtilityNetworkLinkContainer() {
        ...
        container          =  new Dictionary<int, Dictionary<string, HashSet<WirelessPowerPort>>>();
    }
    ...
    public int  Count(int worldId, string name) { return GetPortalWireSet(worldId, name)?.Count ?? 0; }
