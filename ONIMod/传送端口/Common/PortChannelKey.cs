...
public struct PortChannelKey : IEquatable<PortChannelKey> {
    ...
    public override bool Equals(object obj) { return obj is PortChannelKey other && Equals(other); }
    ...
    public override string ToString()                                    { return RsObjectDebug.BuildAllField(this); }
    public static   bool operator ==(PortChannelKey a, PortChannelKey b) { return Equals(a, b); }
    public static   bool operator !=(PortChannelKey a, PortChannelKey b) { return !Equals(a, b); }
}