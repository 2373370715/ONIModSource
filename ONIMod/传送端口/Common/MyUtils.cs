...
public static partial class MyUtils {
    ...
    public static long CurrentSecond => (System.DateTime.Now.ToUniversalTime().Ticks - 621355968000000000) / 10000000;
    public static string UniqueSaveName(string name) { return name + "-" + ID.Next(); }
    ...
    public static BuildingDef CreateTransferBuildingDef(string   id,
                                                        string   anim,
                                                        float[]  construction_mass,
                                                        string[] construction_materials) {
        var buildingDef = global::BuildingTemplates.CreateBuildingDef(id,
                                                                      1,
                                                                      1,
                                                                      anim,
                                                                      30,
    ...
    public class BuildingTemplates {
        ...
        public BuildingDef ToBuildingDef() {
            return global::BuildingTemplates.CreateBuildingDef(id,
                                                               width,
                                                               height,
                                                               anim,
                                                               hitpoints,
