...
public class RsBuilding : RsModule<RsBuilding> {
    private readonly List<BuildingInfo> planScreenInfos = new();

    private static void Db_Initialize_Postfix() {
        foreach (var buildingInfo in Instance.planScreenInfos) {
            if (buildingInfo.buildingID == null) return;

            if (buildingInfo.techID != null) AddBuildingToTech(buildingInfo.techID, buildingInfo.buildingID);
    ...
    public RsBuilding RegisterPlanScreenAndTech(string       buildingID,
    ...
    public Advanced ToAdvanced() { return new Advanced(this); }
    ...
    public class Advanced {
        ...
        private          bool         plan;
        private readonly RsBuilding   rsBuilding;
        private          string       subcategoryID;
        private          bool         tech;
        private          string       techID;
        public Advanced(RsBuilding rsBuilding) { this.rsBuilding = rsBuilding; }
        ...
        public Advanced AddBuilding(string buildingId) {
            if (onlyDlc1 && !DlcManager.IsExpansion1Active()) return this;
            ...
            else if (tech) rsBuilding.RegisterTech(buildingId, techID);

            return this;
        }

        public RsBuilding ToNormal() { return rsBuilding; }
    }
}