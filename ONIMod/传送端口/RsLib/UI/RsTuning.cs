...
public static class RsUITuning {
    ...
    public static class Images {
        ...
        static Images() {
            foreach (var sprite in Resources.FindObjectsOfTypeAll<Sprite>()) {
                ...
                if (!string.IsNullOrEmpty(name) && !SPRITES.ContainsKey(name)) SPRITES.Add(name, sprite);
            }
    ...
    public static class Colors {
        static Colors() {
            ...
            var color1 = new Color(0.0f,   0.0f,   0.0f);
            var color2 = new Color(0.784f, 0.784f, 0.784f, 1f);
    ...
    public class Prefabs {
        ...
        /// <summary>
        ///     |- 	InputField	[-403866 active 0x0]	[UnityEngine.RectTransform | UnityEngine.CanvasRenderer |
        ///     UnityEngine.UI.LayoutElement | KInputTextField | UnityEngine.UI.Image | KNumberInputField]
        ///     |- 	Text Area	[-403880 active 0x0]	[UnityEngine.RectTransform]
        ///     |- 	InputField(Clone) Input Caret	[-403900 active 0x0]	[UnityEngine.RectTransform | UnityEngine.CanvasRenderer |
        ///     TMPro.TMP_SelectionCaret | UnityEngine.UI.LayoutElement]
        ///     |- 	Placeholder	[-403884 active 0x0]	[UnityEngine.RectTransform | UnityEngine.CanvasRenderer | LocText |
        ///     SetTextStyleSetting]
        /// </summary>
        [Resource("InputField")]
        ...
        /// <summary>
        ///     |- 	Checkbox	[29124 active 24x24 anchor:0x1x0x1 rect:0x12x24x-12 offset:196x-28.5x220x-4.5]
        ///     [UnityEngine.RectTransform | UnityEngine.CanvasRenderer | MultiToggle | UnityEngine.UI.LayoutElement | ToolTip |
        ///     HierarchyReferences]
        ///     |- 	BG	[32418 active -20.43x-3.08 anchor:0x0x1x1 rect:-1.785x10.46x1.785x-10.46 offset:19x1.38x-1.43x-1.7]
        ///     [UnityEngine.RectTransform | UnityEngine.CanvasRenderer | UnityEngine.UI.Image]
        ///     |- 	Border	[32452 active 0x0 anchor:0x0x1x1 rect:-12x12x12x-12 offset:0x0x0x0]	[UnityEngine.RectTransform |
        ///     UnityEngine.CanvasRenderer | UnityEngine.UI.Image]
        ///     |- 	ToggledIcon	[30084 active -4x-4 anchor:0x0x1x1 rect:-10x10x10x-10 offset:2x2x-2x-2]	[UnityEngine.RectTransform
        ///     | UnityEngine.CanvasRenderer | UnityEngine.UI.Image]
        /// </summary>
        [Resource("Checkbox")]
        ...
        /// <summary>
        ///     |- 	toggleEntry	[-398960 noActive 310x22 anchor:0x1x0x1 rect:-155x11x155x-11 offset:0x-24x310x-2]
        ///     [UnityEngine.RectTransform | UnityEngine.UI.HorizontalLayoutGroup | UnityEngine.UI.LayoutElement]
        ///     |- 	Label	[-398968 active 207x20.73 anchor:0x1x0x1 rect:-103.5x10.365x103.5x-10.365
        ///     offset:10x-21.365x217x-0.6350002]	[UnityEngine.RectTransform | UnityEngine.CanvasRenderer | LocText |
        ///     UnityEngine.UI.LayoutElement]
        ///     >> [text:Parameter]
        ///     |- 	Toggle	[-398978 active 89x20 anchor:0x1x0x1 rect:-44.5x10x44.5x-10 offset:221x-21x310x-1]
        ///     [UnityEngine.RectTransform | MultiToggle | UnityEngine.UI.LayoutElement]
        ///     |- 	collider	[-398986 active 150x0 anchor:0x0x1x1 rect:-119.5x10x119.5x-10 offset:-150x0x0x0]
        ///     [UnityEngine.RectTransform | UnityEngine.CanvasRenderer | UnityEngine.UI.Image]
        ///     |- 	Background	[-398994 active 20x20 anchor:0x1x0x1 rect:-10x10x10x-10 offset:0x-20x20x0]
        ///     [UnityEngine.RectTransform | UnityEngine.CanvasRenderer | UnityEngine.UI.Image]
        ///     |- 	Checkmark	[-399002 active -10x-10 anchor:0x0x1x1 rect:-5x5x5x-5 offset:5x5x-5x-5]	[UnityEngine.RectTransform |
        ///     UnityEngine.CanvasRenderer | UnityEngine.UI.Image]
        /// </summary>
        ...
        static Prefabs() {
            ...
            var dictionary = ResourceAttribute.GetFields(typeof(Prefabs));
            foreach (var go in gos)
                if (dictionary.TryGetValue(go.name, out var fieldInfo)) {
                    if (fieldInfo.FieldType == typeof(GameObject))
                        fieldInfo.SetValue(null, go);
                    else {
                        var component = go.GetComponent(fieldInfo.FieldType);
                        if (component != null) fieldInfo.SetValue(null, component);
                    }
                }
        }
    }
    ...
    public class ScriptableObjects {
        ...
        static ScriptableObjects() {
            var settings   = Resources.FindObjectsOfTypeAll<TextStyleSetting>();
            var dictionary = ResourceAttribute.GetFields(typeof(ScriptableObjects));
            foreach (var setting in settings)
                if (dictionary.TryGetValue(setting.name, out var fieldInfo))
                    fieldInfo.SetValue(null, setting);
        }
    }

    public class TextStyleSettings {
        private static readonly Dictionary<string, TextStyleSetting> textStyleSettings = new();
        ...
        static TextStyleSettings() {
            ...
            var dictionary = ResourceAttribute.GetFields(typeof(TextStyleSettings));
        ...
        public static void AddTextStyleSetting(TextStyleSetting setting) { textStyleSettings[setting.name] = setting; }
    }
    ...
    private class ResourceAttribute : Attribute {
        ...
        public ResourceAttribute(string alias) { this.alias = alias; }
        ...
        public static Dictionary<string, FieldInfo> GetFields(Type type) {
            ...
            foreach (var fieldInfo in fieldInfos) {
                var resourceAttribute = fieldInfo.GetCustomAttribute<ResourceAttribute>();
