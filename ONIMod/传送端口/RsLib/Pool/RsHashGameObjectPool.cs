...
public class RsHashGameObjectPool {
    ...
    // private Dictionary<object, GameObject> dic = new Dictionary<object, GameObject>();
    private readonly Dictionary<object, GameObject> dic      = new();
    private readonly HashSet<object>                noRecord = new();
    private readonly UIGameObjectPool               pool;
    public RsHashGameObjectPool(GameObject prefab) { pool = new UIGameObjectPool(prefab); }
    public void RecordStart() { noRecord.UnionWith(dic.Keys); }
    ...
    public bool HasElement(object    key) { return dic.ContainsKey(key); }
    public void RecordElement(object key) { noRecord.Remove(key); }
    ...
    public bool GetFreeElement(object         key,
                               out GameObject element,
                               GameObject     instantiateParent = null,
    ...
    public void GetFreeElement(object         key,
                               out GameObject element,
                               out bool       isNew,
                               GameObject     instantiateParent = null,
                               bool           forceActive       = false) {
