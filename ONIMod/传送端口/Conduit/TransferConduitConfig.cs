...
public class LiquidTransferConduitSenderConfig : TransferConduitConfig {
    ...
    public override string defaultName => MYSTRINGS.BUILDINGS.PREFABS.RSLIQUIDTRANSFERCONDUITSENDER.DEFAULTNAME;
}
...
public class LiquidTransferConduitReceiverConfig : TransferConduitConfig {
    ...
    public override string defaultName => MYSTRINGS.BUILDINGS.PREFABS.RSLIQUIDTRANSFERCONDUITRECEIVER.DEFAULTNAME;
}
...
public class GasTransferConduitSenderConfig : TransferConduitConfig {
    ...
    public override string defaultName => MYSTRINGS.BUILDINGS.PREFABS.RSGASTRANSFERCONDUITSENDER.DEFAULTNAME;
}
...
public class GasTransferConduitReceiverConfig : TransferConduitConfig {
    ...
    public override string defaultName => MYSTRINGS.BUILDINGS.PREFABS.RSGASTRANSFERCONDUITRECEIVER.DEFAULTNAME;
}
...
public class SolidTransferConduitSenderConfig : TransferConduitConfig {
    ...
    public override string defaultName => MYSTRINGS.BUILDINGS.PREFABS.RSSOLIDTRANSFERCONDUITSENDER.DEFAULTNAME;
}
...
public class SolidTransferConduitReceiverConfig : TransferConduitConfig {
    ...
    public override string defaultName => MYSTRINGS.BUILDINGS.PREFABS.RSSOLIDTRANSFERCONDUITRECEIVER.DEFAULTNAME;
}
...
public abstract class TransferConduitConfig : IBuildingConfig {
    ...
    public override BuildingDef CreateBuildingDef() {
        ...
        var buildingDef
            = MyUtils.CreateTransferBuildingDef(id, anim, BUILDINGS.CONSTRUCTION_MASS_KG.TIER6, refined_METALS);
    ...
    public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag) {
        ...
        channel.BuildingType = conduitType switch {
