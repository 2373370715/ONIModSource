...
public class WirelessPowerPort : UtilityNetworkLink, IHaveUtilityNetworkMgr, ICircuitConnected {
    [MyCmpGet]
    public TransferPortChannel channelItem;

    public object             VirtualCircuitKey   { get; private set; }
    public bool               IsVirtual           { get; }
    public int                PowerCell           => GetNetworkCell();
    public IUtilityNetworkMgr GetNetworkManager() { return Game.Instance.electricalConduitSystem; }
    ...
    protected override void OnDisconnect(int cell1, int cell2) {
        var channelController = VirtualCircuitKey as SingleChannelController;
        if (channelController == null || channelController.IsInvalid()) return;
