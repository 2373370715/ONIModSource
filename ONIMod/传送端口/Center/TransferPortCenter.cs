...
public class TransferPortCenter : StateMachineComponent<TransferPortCenter.StatesInstance> {
    ...
    public class StatesInstance : GameStateMachine<States, StatesInstance, TransferPortCenter, object>.GameInstance {
        public StatesInstance(TransferPortCenter smi) : base(smi) { }
    }

    public class States : GameStateMachine<States, StatesInstance, TransferPortCenter> {
