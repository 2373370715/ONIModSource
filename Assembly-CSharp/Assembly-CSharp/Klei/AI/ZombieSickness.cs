...
namespace Klei.AI {
    public class ZombieSickness : Sickness {
        ...
        public ZombieSickness() : base("ZombieSickness",
                                       SicknessType.Pathogen,
                                       Severity.Major,
                                       0.00025f,
                                       new List<InfectionVector> {
                                           InfectionVector.Inhalation, InfectionVector.Contact
                                       },
                                       10800f,
            ...
            AddSicknessComponent(new AnimatedSickness(new HashedString[] {
                                                          "anim_idle_spores_kanim", "anim_loco_spore_kanim"
                                                      },
            ...
            AddSicknessComponent(new AttributeModifierSickness(new[] {
                ...
                new AttributeModifier(Db.Get().Attributes.Construction.Id,
                                      -10f,
