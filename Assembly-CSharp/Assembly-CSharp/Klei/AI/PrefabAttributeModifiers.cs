...
namespace Klei.AI {
    ...
    public class PrefabAttributeModifiers : KMonoBehaviour {
        ...
        public             void AddAttributeDescriptor(AttributeModifier modifier) { descriptors.Add(modifier); }
        public             void RemovePrefabAttribute(AttributeModifier modifier) { descriptors.Remove(modifier); }
    }
}