...
public class PolymerizerConfig : IBuildingConfig {
    ...
    public override BuildingDef CreateBuildingDef() {
        ...
        var width               = 3;
        var height              = 3;
        var anim                = "plasticrefinery_kanim";
        var hitpoints           = 30;
    ...
    public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag) {
        ...
        var polymerizer = go.AddOrGet<Polymerizer>();
        ...
        conduitDispenser.elementFilter       = new[] { SimHashes.CarbonDioxide };
        var elementConverter = go.AddOrGet<ElementConverter>();
        elementConverter.consumedElements
            = new[] { new ElementConverter.ConsumedElement(INPUT_ELEMENT_TAG, 0.8333333f) };

        elementConverter.outputElements = new[] {
            new ElementConverter.OutputElement(0.5f,         SimHashes.Polypropylene, 348.15f, false, true),
            new ElementConverter.OutputElement(0.008333334f, SimHashes.Steam,         473.15f, false, true),
            new ElementConverter.OutputElement(0.008333334f, SimHashes.CarbonDioxide, 423.15f, false, true)
        };
