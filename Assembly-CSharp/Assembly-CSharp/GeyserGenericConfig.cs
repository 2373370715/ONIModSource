...
public class GeyserGenericConfig : IMultiEntityConfig {
    ...
    public List<GameObject> CreatePrefabs() {
        ...
        foreach (var geyserPrefabParams in configs)
            list.Add(CreateGeyser(geyserPrefabParams.id,
                                  geyserPrefabParams.anim,
                                  geyserPrefabParams.width,
                                  geyserPrefabParams.height,
                                  Strings.Get(geyserPrefabParams.nameStringKey),
                                  Strings.Get(geyserPrefabParams.descStringKey),
                                  geyserPrefabParams.geyserType.idHash,
                                  geyserPrefabParams.geyserType.geyserTemperature));

        configs.RemoveAll(x => !x.isGenericGeyser);
        var gameObject = EntityTemplates.CreateEntity("GeyserGeneric", "Random Geyser Spawner");
        ...
        gameObject.GetComponent<KPrefabID>().prefabInitFn += delegate(GameObject inst) {
                                                                 ...
                                                                 if (SaveLoader.Instance.clusterDetailSave != null)
                                                                     num = SaveLoader.Instance.clusterDetailSave
                                                                         .globalWorldSeed;
                                                                 else
                                                                     Debug
                                                                         .LogWarning("Could not load global world seed for geysers");

                                                                 num = num                                 +
                                                                       (int)inst.transform.GetPosition().x +
                                                                       (int)inst.transform.GetPosition().y;

                                                                 var index = new KRandom(num).Next(0, configs.Count);
                                                                 GameUtil
                                                                     .KInstantiate(Assets.GetPrefab(configs[index].id),
                                                                      inst.transform.GetPosition(),
    ...
    public static GameObject CreateGeyser(string       id,
                                          string       anim,
                                          int          width,
                                          int          height,
                                          string       name,
        ...
        var gameObject = EntityTemplates.CreatePlacedEntity(id,
                                                            ...
                                                            tier2,
                                                            SimHashes.Creature,
                                                            new List<Tag> { GameTags.GeyserFeature });

        gameObject.AddOrGet<OccupyArea>().objectLayers = new[] { ObjectLayer.Building };
        ...
        SoundEventVolumeCache.instance.AddVolume("geyser_side_steam_kanim",
                                                 "Geyser_shake_LP",
    ...
    private List<GeyserPrefabParams> GenerateConfigs() {
        var list = new List<GeyserPrefabParams>();
        list.Add(new GeyserPrefabParams("geyser_gas_steam_kanim",
                                        2,
                                        4,
        ...
        list.Add(new GeyserPrefabParams("geyser_gas_steam_hot_kanim",
                                        2,
                                        4,
        ...
        list.Add(new GeyserPrefabParams("geyser_liquid_water_hot_kanim",
                                        4,
                                        2,
        ...
        list.Add(new GeyserPrefabParams("geyser_liquid_water_slush_kanim",
                                        4,
                                        2,
        ...
        list.Add(new GeyserPrefabParams("geyser_liquid_water_filthy_kanim",
                                        4,
                                        2,
                                        new GeyserConfigurator.GeyserType("filthy_water",
                                            ...
                                            idx = Db.Get().Diseases.GetIndex("FoodPoisoning"), count = 20000
                                        }),
                                        true));

        list.Add(new GeyserPrefabParams("geyser_liquid_salt_water_cool_slush_kanim",
                                        4,
                                        2,
        ...
        list.Add(new GeyserPrefabParams("geyser_liquid_salt_water_kanim",
                                        4,
                                        2,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_volcano_small_kanim",
                                        3,
                                        3,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_volcano_big_kanim",
                                        3,
                                        3,
        ...
        list.Add(new GeyserPrefabParams("geyser_liquid_co2_kanim",
                                        4,
                                        2,
                                        new GeyserConfigurator.GeyserType("liquid_co2",
        ...
        list.Add(new GeyserPrefabParams("geyser_gas_co2_hot_kanim",
                                        2,
                                        4,
                                        new GeyserConfigurator.GeyserType("hot_co2",
        ...
        list.Add(new GeyserPrefabParams("geyser_gas_hydrogen_hot_kanim",
                                        2,
                                        4,
        ...
        list.Add(new GeyserPrefabParams("geyser_gas_po2_hot_kanim",
                                        2,
                                        4,
                                        new GeyserConfigurator.GeyserType("hot_po2",
        ...
        list.Add(new GeyserPrefabParams("geyser_gas_po2_slimy_kanim",
                                        2,
                                        4,
                                        new GeyserConfigurator.GeyserType("slimy_po2",
                                                                          SimHashes.ContaminatedOxygen,
                                                                          GeyserConfigurator.GeyserShape.Gas,
                                                                          333.15f,
                                                                          70f,
                                                                          140f,
                                                                          5f).AddDisease(new SimUtil.DiseaseInfo {
                                            idx = Db.Get().Diseases.GetIndex("SlimeLung"), count = 5000
                                        }),
                                        true));

        list.Add(new GeyserPrefabParams("geyser_gas_chlorine_kanim",
                                        2,
                                        4,
                                        new GeyserConfigurator.GeyserType("chlorine_gas",
        ...
        list.Add(new GeyserPrefabParams("geyser_gas_methane_kanim",
                                        2,
                                        4,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_copper_kanim",
                                        3,
                                        3,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_iron_kanim",
                                        3,
                                        3,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_gold_kanim",
                                        3,
                                        3,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_aluminum_kanim",
                                        3,
                                        3,
                                        new GeyserConfigurator.GeyserType("molten_aluminum",
                                                                          SimHashes.MoltenAluminum,
                                                                          GeyserConfigurator.GeyserShape.Molten,
                                                                          2000f,
                                                                          200f,
                                                                          400f,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_tungsten_kanim",
                                        3,
                                        3,
                                        new GeyserConfigurator.GeyserType("molten_tungsten",
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_niobium_kanim",
                                        3,
                                        3,
                                        new GeyserConfigurator.GeyserType("molten_niobium",
                                                                          SimHashes.MoltenNiobium,
                                                                          GeyserConfigurator.GeyserShape.Molten,
                                                                          3500f,
                                                                          800f,
                                                                          1600f,
        ...
        list.Add(new GeyserPrefabParams("geyser_molten_cobalt_kanim",
                                        3,
                                        3,
                                        new GeyserConfigurator.GeyserType("molten_cobalt",
                                                                          SimHashes.MoltenCobalt,
                                                                          GeyserConfigurator.GeyserShape.Molten,
                                                                          2500f,
                                                                          200f,
                                                                          400f,
        ...
        list.Add(new GeyserPrefabParams("geyser_liquid_oil_kanim",
                                        4,
                                        2,
                                        new GeyserConfigurator.GeyserType("oil_drip",
                                                                          SimHashes.CrudeOil,
                                                                          GeyserConfigurator.GeyserShape.Liquid,
                                                                          600f,
                                                                          1f,
        ...
        list.Add(new GeyserPrefabParams("geyser_liquid_sulfur_kanim",
                                        4,
                                        2,
                                        new GeyserConfigurator.GeyserType("liquid_sulfur",
        ...
        list.RemoveAll(geyser => !geyser.geyserType.DlcID.IsNullOrWhiteSpace() &&
                                 !DlcManager.IsContentSubscribed(geyser.geyserType.DlcID));

        return list;
    }

    public struct GeyserPrefabParams {
        public GeyserPrefabParams(string anim,
                                  int width,
                                  int height,
