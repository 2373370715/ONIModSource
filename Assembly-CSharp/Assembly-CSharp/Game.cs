...
public class Game : KMonoBehaviour {
    ...
    public bool SandboxModeActive {
        ...
        set {
            ...
            if (OverlayMenu.Instance    != null) OverlayMenu.Instance.Refresh();
            if (ManagementMenu.Instance != null) ManagementMenu.Instance.Refresh();
        }
    }
    ...
    public static bool                  IsOnMainThread()      { return MainThread == Thread.CurrentThread; }
    ...
    protected override void OnPrefabInit() {
        ...
        changelistsPlayedOn.Add(642695U);
    ...
    public void Save(BinaryWriter writer) {
        ...
        if (!changelistsPlayedOn.Contains(642695U)) changelistsPlayedOn.Add(642695U);
